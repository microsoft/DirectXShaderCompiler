...
class db_dxil(object):
    ...
    def build_valrules(self):
        ...
        self.add_valrule_msg(
            ...
            "Total Thread Group Shared Memory used by %0 is %1, exceeding maximum: %2, accessing %3.",
        )
        self.add_valrule_msg(
            ...
            "Total Thread Group Shared Memory used by %0 is %1, exceeding explicit limit: %2, accessing %3.",
        )
        self.add_valrule(
