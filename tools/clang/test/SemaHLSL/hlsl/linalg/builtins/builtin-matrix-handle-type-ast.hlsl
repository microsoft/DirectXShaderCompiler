...
// CHECK: FieldDecl {{.*}} handle '__builtin_LinAlg_Matrix':'__builtin_LinAlg Matrix'
struct S {
  __builtin_LinAlg_Matrix handle;
};

// CHECK: VarDecl {{.*}} global_handle '__builtin_LinAlg_Matrix':'__builtin_LinAlg Matrix'
__builtin_LinAlg_Matrix global_handle;

// CHECK: FunctionDecl {{.*}} f1 'void (__builtin_LinAlg_Matrix)'
// CHECK: ParmVarDecl {{.*}} m '__builtin_LinAlg_Matrix':'__builtin_LinAlg Matrix'
...
// CHECK-NEXT: DeclStmt
// CHECK-NEXT: VarDecl {{.*}} m '__builtin_LinAlg_Matrix':'__builtin_LinAlg Matrix'
[shader("compute")]
[numthreads(4,1,1)]
void main() {
