...
class db_dxil(object):
    ...
    def populate_dxil_operations(self):
        ...
        self.add_dxil_op("WavePrefixBitCount", next_op_idx, "WavePrefixOp", "returns the count of bits set to 1 on prior lanes", "v", "", [
            ...
            db_dxil_param(2, "i1", "value", "input value")])
        next_op_idx += 1
        self.add_dxil_op("Barycentrics", next_op_idx, "Barycentrics", "return weights at a current location.", "hf", "rn", [
            db_dxil_param(0, "$o", "", "result"),
            db_dxil_param(2, "i8", "VertexID", "Index of vertices")])
        next_op_idx += 1
        self.add_dxil_op("BarycentricsCentroid", next_op_idx, "BarycentricsCentroid", "return weights at centroid location.", "hf", "rn", [
            db_dxil_param(0, "$o", "", "result"),
            db_dxil_param(2, "i8", "VertexID", "Index of vertices")])
        next_op_idx += 1
        self.add_dxil_op("BarycentricsSampleIndex", next_op_idx, "BarycentricsSampleIndex", "return weights at the location of the sample specified by index", "hf", "rn", [
            db_dxil_param(0, "$o", "", "result"),
            db_dxil_param(2, "i8", "VertexID", "Index of vertices"),
            db_dxil_param(3, "i32", "sampleIndex", "sample index")])
        next_op_idx += 1
        self.add_dxil_op("BarycentricsSnapped", next_op_idx, "BarycentricsSnapped", "return weights at the location specified in the pixel's 16x16 sample grid", "hf", "rn", [
            db_dxil_param(0, "$o", "", "result"),
            db_dxil_param(2, "i8", "VertexID", "Index of vertices"),
        ...
        self.add_dxil_op("AttributeAtVertex", next_op_idx, "AttributeAtVertex", "returns the values of the attributes at the vertex.", "hf", "rn", [
            ...
            db_dxil_param(3, "i32", "inputRowIndex", "row index of an input attribute"),
            db_dxil_param(4, "i8", "inputColIndex", "column index of an input attribute"),
            db_dxil_param(5, "i8", "VertexID", "Index of vertices")
        ])
        next_op_idx += 1
