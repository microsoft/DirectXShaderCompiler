...
// CHECK: [[val_4:%[a-zA-Z0-9_]+]] = OpImageDrefGather %v4float [[cube_load]] [[v3fc]] %float_0_5 None
// CHECK: OpStore %val [[val_4]]
    val = texCube.GatherCmp(float3(0.5, 0.25, 0), 0.5);

// CHECK: [[cube_arr_load:%[a-zA-Z0-9_]+]] = OpLoad [[type_cube_sampled_image_array]] %texCubeArray
// CHECK: [[val_5:%[a-zA-Z0-9_]+]] = OpImageDrefGather %v4float [[cube_arr_load]] [[v4fc]] %float_0_5 None
// CHECK: OpStore %val [[val_5]]
    val = texCubeArray.GatherCmp(float4(0.5, 0.25, 0, 0), 0.5);
