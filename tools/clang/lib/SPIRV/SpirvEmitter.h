...
private:
  ...
  /// processLoadRawBuffer() handles `T vk::LoadRawBuffer<T>()` and
  /// processRawBufferLoad() handles `uint vk::RawBufferLoad()`.
  SpirvInstruction *processLoadRawBuffer(const CallExpr *callExpr);
