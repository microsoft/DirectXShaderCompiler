...
// HLSL Comment - still a problem with more recent versions
...
static void EncodeFixedType(Record *R, std::vector<unsigned char> &ArgCodes,
  ...
  switch (VT) {
  default: break;
  case MVT::iPTRAny: ++Tmp; __fallthrough; // HLSL Change
  case MVT::vAny: ++Tmp; __fallthrough; // HLSL Change
  case MVT::fAny: ++Tmp; __fallthrough; // HLSL Change
  case MVT::iAny: ++Tmp; __fallthrough; // HLSL Change
  case MVT::Any: {
