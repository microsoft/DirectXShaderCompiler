...
// CHECK-NEXT: OpStore %temp_var_v3float [[add]]
// CHECK-NEXT: [[access11:%\d+]] = OpAccessChain %_ptr_Function_float %temp_var_v3float %uint_0
...
// CHECK-NEXT: OpStore %temp_var_vector [[mul]]
// CHECK-NEXT: [[access12:%\d+]] = OpAccessChain %_ptr_Function_float %temp_var_vector [[index2]]
