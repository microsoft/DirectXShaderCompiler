...
// CHECK:      [[val5:%[a-zA-Z0-9_]+]] = OpImageGather %v4float [[cube_load]] [[v3fc]] %int_0 None
    float4 val5 = texCube.Gather(float3(0.5, 0.25, 0));

// CHECK: [[cube_arr_load:%[a-zA-Z0-9_]+]] = OpLoad [[type_cube_sampled_image_array]] %texCubeArray
// CHECK:      [[val6:%[a-zA-Z0-9_]+]] = OpImageGather %v4float [[cube_arr_load]] [[v4fc]] %int_0 None
    float4 val6 = texCubeArray.Gather(float4(0.5, 0.25, 0, 0));
