...
bool DxcOpts::IsLibraryProfile() { return TargetProfile.startswith("lib_"); }

bool DxcOpts::GenerateFullDebugInfo() { return DebugInfo; }

bool DxcOpts::GeneratePDB() { return DebugInfo || SourceOnlyDebug; }

bool DxcOpts::EmbedDebugInfo() { return EmbedDebug; }

bool DxcOpts::EmbedPDBName() { return GeneratePDB() || !DebugFile.empty(); }
...
int ReadDxcOpts(const OptTable *optionTable, unsigned flagsToInclude,
  ...
  opts.EnableLifetimeMarkers =
      Args.hasFlag(OPT_enable_lifetime_markers, OPT_INVALID,
