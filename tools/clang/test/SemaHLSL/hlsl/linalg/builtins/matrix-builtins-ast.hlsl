...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_CopyConvertMatrix(mat2, mat1, true);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_FillMatrix(mat1, true, 15);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixAccumulate(mat1, mat2, mat3);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixAccumulateToMemory(mat1, SharedArr, 0, 0, 0);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  uint2 coord = dx::__builtin_LinAlg_MatrixGetCoordinate(mat1, 0);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  uint elem1;
  dx::__builtin_LinAlg_MatrixGetElement(elem1, mat1, 3);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  float elem2;
  dx::__builtin_LinAlg_MatrixGetElement(elem2, mat1, 4);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  uint length = dx::__builtin_LinAlg_MatrixLength(mat1);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixLoadFromDescriptor(mat1, Buf, 0, 0, 0, 4);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixLoadFromMemory(mat1, SharedArr, 0, 0, 0);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixMatrixMultiply(mat1, mat2, mat3);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixMatrixMultiplyAccumulate(mat1, mat2, mat3, mat1);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixSetElement(mat2, mat1, 1, 1);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_MatrixStoreToDescriptor(mat1, Buf, 1, 2, 3, 4);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  ...
  dx::__builtin_LinAlg_MatrixStoreToMemory(mat1, SharedArr, 0, 0, 0);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  float4 vec = {1,2,3,4};
  float4 result;
  dx::__builtin_LinAlg_MatrixVectorMultiply(result, mat1, true, vec, 1);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  ...
  float4 bias = {5,6,7,8};
  dx::__builtin_LinAlg_MatrixVectorMultiplyAdd(result, mat1, true, input, 1, bias);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  int4 result2;
  dx::__builtin_LinAlg_Convert(result2, vec, 0, 1);
...
// CHECK-NEXT: AvailabilityAttr {{.*}} Implicit  6.10 0 0 ""
  dx::__builtin_LinAlg_VectorAccumulateToDescriptor(Buf, 10, 64, input);
}
