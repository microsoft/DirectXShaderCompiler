...
// CHECK: <line:9:1, col:19> col:19 myCBuffer 'ConstantBuffer<S>':'const !ConstantBuffer<S>'
ConstantBuffer<S> myCBuffer;

// CHECK: <line:12:1, col:18> col:18 myTBffer 'TextureBuffer<S>':'const !TextureBuffer<S>'
