...
//CHECK-DAG: tx0.t2                            texture     f32          2d      T{{0|1}}             t1     1
//CHECK-DAG: tx0.t                             texture     f32          2d      T{{1|0}}             t0     1
//CHECK-DAG: tx1.t2                            texture     f32          2d      T{{2|3}}             t6     1
//CHECK-DAG: tx1.t                             texture     f32          2d      T{{3|2}}             t5     1
