...
[NodeLaunch("Broadcasting")]
[NumThreads(256,1,1)]
void node05([MaxOutputRecords(5)] NodeOutput<RECORD> outputs)
{
...
[NodeLaunch("Broadcasting")]
[NumThreads(256,1,4)]
void node08([MaxOutputRecords(5)] NodeOutput<RECORD> outputs)
{
...
// CHECK:   call void @dx.op.barrierByNodeRecordHandle(i32 {{[0-9]+}}, %dx.types.NodeRecordHandle [[ANN_NODE08_B]], i32 1, i32 1)  ; BarrierByNodeRecordHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE09_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE10_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE12_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE13_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE14_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE15_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE16_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
...
// CHECK:   call void @dx.op.barrierByMemoryHandle(i32 {{[0-9]+}}, %dx.types.Handle [[NODE17_C]], i32 1, i32 1)  ; BarrierByMemoryHandle(object,AccessFlags,SyncFlags)
