...
void matrix_unsigned() {
   ...
   unsigned min12int2x3 min12intvector;                       /* expected-warning {{min12int is promoted to min16int}} expected-error {{'min12int' cannot be signed or unsigned}} fxc-error {{X3085: unsigned can not be used with type}} */
