...
*: For fast math mode, division can be implemented as 1/mul(%src1) by drivers. So in preserving denorm case, This can lead to multiplying the number by infinity. For example, dividing denorm value by itself may result in 1 or infinity.
