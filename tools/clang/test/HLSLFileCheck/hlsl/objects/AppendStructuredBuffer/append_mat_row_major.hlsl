...
// CHK_MAT2x3: dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 0, i16 1, i16 2, i16 3, i16 4, i8 15, i32 4)
// CHK_MAT2x3: dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 8, i16 5, i16 6, i16 undef, i16 undef, i8 3, i32 4)

// CHK_MAT3x2: dx.op.bufferUpdateCounter
// CHK_MAT3x2: dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 0, i16 1, i16 2, i16 3, i16 4, i8 15, i32 4)
// CHK_MAT3x2: dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 8, i16 5, i16 6, i16 undef, i16 undef, i8 3, i32 4)
