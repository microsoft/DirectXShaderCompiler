...
using MatrixBTy = Matrix<ComponentType::F16, 8, 8, MatrixUse::B, MatrixScope::Thread>;
...
// CHECK: %[[MAT1:.*]] = call %dx.types.LinAlgMatrixC8M8N8U1S0 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M8N8U1S0(
...
// CHECK-SAME: ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  MatrixBTy Mat1 = MatrixBTy::Load<MatrixLayoutEnum::ColMajor>(BAB, 0, 8);

  vector<half, 8> vec1 = 10.3f;

// CHECK: %[[VEC2:.*]] = call <8 x half> @dx.op.linAlgMatVecMul.v8f16.mC8M8N8U1S0.v8f16(i32 -2147483623,
// CHECK-SAME: %dx.types.LinAlgMatrixC8M8N8U1S0 %3, <8 x half> <half 0xH4926, half 0xH4926, half 0xH4926,
...
// CHECK: %[[VEC3:.*]] = call <8 x half> @dx.op.linAlgMatVecMulAdd.v8f16.mC8M8N8U1S0.v8f16.v8f16(i32 -2147483622,
// CHECK-SAME: %dx.types.LinAlgMatrixC8M8N8U1S0 %[[MAT1]], <8 x half> <half 0xH4926, half 0xH4926, half 0xH4926,
...
// CHECK: %[[VEC4:.*]] = call <8 x half> @dx.op.linAlgMatVecMulAdd.v8f16.mC8M8N8U1S0.v8f16.v8f16(i32 -2147483622,
// CHECK-SAME: %dx.types.LinAlgMatrixC8M8N8U1S0 %[[MAT1]], <8 x half> %[[VEC2]], i32 8, <8 x half> %[[VEC3]], i32 8)
// CHECK-SAME: ; LinAlgMatVecMulAdd(matrix,inputVector,inputInterpretation,biasVector,biasInterpretation)
  ...
  // CHECK: %[[VEC5:.*]] = call <8 x half> @dx.op.linAlgMatVecMulAdd.v8f16.mC8M8N8U1S0.v8f16.v8i16(i32 -2147483622,
  // CHECK-SAME: %dx.types.LinAlgMatrixC8M8N8U1S0 %[[MAT1]], <8 x half> %[[VEC3]], i32 8, <8 x i16> %[[VEC_BIAS]], i32 2)
  // CHECK-SAME:; LinAlgMatVecMulAdd(matrix,inputVector,inputInterpretation,biasVector,biasInterpretation)
  ...
  // CHECK: %[[VEC6:.*]] = call <8 x half> @dx.op.linAlgMatVecMulAdd.v8f16.mC8M8N8U1S0.v8f16.v8i16(i32 -2147483622,
  // CHECK-SAME: %dx.types.LinAlgMatrixC8M8N8U1S0 %[[MAT1]], <8 x half> %[[VEC2]], i32 8, <8 x i16> %[[VEC_BIAS]], i32 2)
  // CHECK-SAME: ; LinAlgMatVecMulAdd(matrix,inputVector,inputInterpretation,biasVector,biasInterpretation)
