...
; CHECK: Function: {{.*}}mainCH{{.*}}: error: Thread Group Shared Memory not supported from non-compute entry points.
...
!dx.shaderModel = !{!7}
!dx.resources = !{!8}
!dx.dxrPayloadAnnotations = !{!13}
!dx.entryPoints = !{!16, !18}
...
!13 = !{i32 0, %struct.RayPayload undef, !14}
!14 = !{!15}
!15 = !{i32 0, i32 13107}
!16 = !{null, !"", null, !8, !17}
