...
private:
  ...
  HRESULT CopyBlobWideToBSTR(IDxcBlobWide *pBlob,
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetSourceCount(_Out_ UINT32 *pCount) override {
    return m_pImpl->GetSourceCount(pCount);
  }

  virtual HRESULT STDMETHODCALLTYPE GetSource(
      _In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobEncoding **ppResult) override {
    return m_pImpl->GetSource(uIndex, ppResult);
  }

  virtual HRESULT STDMETHODCALLTYPE
  GetSourceName(_In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetFlagCount(_Out_ UINT32 *pCount) override {
    return m_pImpl->GetFlagCount(pCount);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetFlag(_In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
    IFR(m_pImpl->GetFlag(uIndex, &pBlob));
    return CopyBlobWideToBSTR(pBlob, pResult);
  }
  virtual HRESULT STDMETHODCALLTYPE GetArgCount(_Out_ UINT32 *pCount) override {
    return m_pImpl->GetArgCount(pCount);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetArg(_In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
    IFR(m_pImpl->GetArg(uIndex, &pBlob));
    return CopyBlobWideToBSTR(pBlob, pResult);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetDefineCount(_Out_ UINT32 *pCount) override {
    return m_pImpl->GetDefineCount(pCount);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetDefine(_In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetTargetProfile(_Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
    IFR(m_pImpl->GetTargetProfile(&pBlob));
    return CopyBlobWideToBSTR(pBlob, pResult);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetEntryPoint(_Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
    IFR(m_pImpl->GetEntryPoint(&pBlob));
    return CopyBlobWideToBSTR(pBlob, pResult);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetMainFileName(_Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  OverrideRootSignature(_In_ const WCHAR *pRootSignature) override {
    return E_NOTIMPL;
  }

  virtual HRESULT STDMETHODCALLTYPE
  CompileForFullPDB(_COM_Outptr_ IDxcResult **ppResult) override {
    return E_NOTIMPL;
  }

  virtual HRESULT STDMETHODCALLTYPE
  GetFullPDB(_COM_Outptr_ IDxcBlob **ppFullPDB) override {
    return E_NOTIMPL;
  }

  virtual HRESULT STDMETHODCALLTYPE
  GetHash(_COM_Outptr_ IDxcBlob **ppResult) override {
    return m_pImpl->GetHash(ppResult);
  }

  virtual HRESULT STDMETHODCALLTYPE
  GetName(_Outptr_result_z_ BSTR *pResult) override {
    CComPtr<IDxcBlobWide> pBlob;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetVersionInfo(_COM_Outptr_ IDxcVersionInfo **ppVersionInfo) override {
    return m_pImpl->GetVersionInfo(ppVersionInfo);
  }

  virtual HRESULT STDMETHODCALLTYPE
  SetCompiler(_In_ IDxcCompiler3 *pCompiler) override {
    return E_NOTIMPL;
  }
};
...
public:
  ...
  virtual HRESULT STDMETHODCALLTYPE GetSourceName(
      _In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobWide **ppResult) override {
    if (uIndex >= m_SourceFiles.size())
      return E_INVALIDARG;
  ...
  static inline HRESULT
  GetStringOption(const std::vector<CComPtr<IDxcBlobWide>> &list,
                  _In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobWide **ppResult) {
    if (uIndex >= list.size())
      return E_INVALIDARG;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetFlag(_In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobWide **ppResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetArg(_In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobWide **ppResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetDefine(_In_ UINT32 uIndex, _COM_Outptr_ IDxcBlobWide **ppResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetArgPair(
      ...
      _COM_Outptr_result_maybenull_ IDxcBlobWide **ppValue) override {
    if (!ppName || !ppValue)
      return E_POINTER;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetTargetProfile(_COM_Outptr_ IDxcBlobWide **ppResult) override {
    return CopyBlobWide(m_TargetProfile, ppResult);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetEntryPoint(_COM_Outptr_ IDxcBlobWide **ppResult) override {
    return CopyBlobWide(m_EntryPoint, ppResult);
  }
  virtual HRESULT STDMETHODCALLTYPE
  GetMainFileName(_COM_Outptr_ IDxcBlobWide **ppResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetHash(_COM_Outptr_result_maybenull_ IDxcBlob **ppResult) override {
    if (!ppResult)
      return E_POINTER;
    *ppResult = nullptr;
    if (m_HashBlob)
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetWholeDxil(_COM_Outptr_result_maybenull_ IDxcBlob **ppResult) override {
    if (!ppResult)
      return E_POINTER;
    *ppResult = nullptr;
    if (m_WholeDxil)
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetName(_COM_Outptr_result_maybenull_ IDxcBlobWide **ppResult) override {
  ...
  virtual HRESULT STDMETHODCALLTYPE GetVersionInfo(
      _COM_Outptr_result_maybenull_ IDxcVersionInfo **ppVersionInfo) override {
    if (!ppVersionInfo)
      return E_POINTER;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetLibraryPDBCount(_Out_ UINT32 *pCount) override {
    if (!pCount)
      return E_POINTER;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetLibraryPDB(
      ...
      _COM_Outptr_opt_result_maybenull_ IDxcBlobWide **ppLibraryName) override {
    if (!ppOutPdbUtils)
      return E_POINTER;
  ...
  virtual HRESULT STDMETHODCALLTYPE
  GetCustomToolchainID(_Out_ UINT32 *pID) override {
    if (!pID)
      return E_POINTER;
  ...
  virtual HRESULT STDMETHODCALLTYPE GetCustomToolchainData(
      _COM_Outptr_opt_result_maybenull_ IDxcBlob **ppBlob) override {
    if (!ppBlob)
      return E_POINTER;
    *ppBlob = nullptr;
