...
// CHECK-DAG: 15:{{[0-9]+}}: error: Opcode Pack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 16:{{[0-9]+}}: error: Opcode Unpack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 17:{{[0-9]+}}: error: Opcode Unpack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 18:{{[0-9]+}}: error: Opcode Pack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 19:{{[0-9]+}}: error: Opcode Pack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 20:{{[0-9]+}}: error: Opcode Unpack4x8 not valid in shader model ps_6_5
// CHECK-DAG: 21:{{[0-9]+}}: error: Opcode Unpack4x8 not valid in shader model ps_6_5
