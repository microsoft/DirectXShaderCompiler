...
// CHECK: {{.*g_m1.*}} = external constant %class.matrix.int.2.2.Col, align 4
// CHECK: {{.*g_m2.*}} = external constant %class.matrix.int.2.2.Col, align 4
...
// CHECK-NOT: {{(.*g_m1.*)(.*static.copy.*)}} = internal global %class.matrix.int.2.2.Col zeroinitializer
// CHECK: {{(.*g_m2.*)(.*static.copy.*)}} = internal global %class.matrix.int.2.2.Col zeroinitializer
