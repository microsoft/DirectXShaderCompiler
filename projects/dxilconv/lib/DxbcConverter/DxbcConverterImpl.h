...
public:
  ...
  Convert(_In_reads_bytes_(DxbcSize) LPCVOID pDxbc, _In_ UINT32 DxbcSize,
...
protected:
  ...
  virtual void
  LogConvertResult(bool InDriver, _In_ const LARGE_INTEGER *pQPCConvertStart,
                   _In_ const LARGE_INTEGER *pQPCConvertEnd,
                   _In_reads_bytes_(DxbcSize) LPCVOID pDxbc,
                   _In_ UINT32 DxbcSize, _In_opt_z_ LPCWSTR pExtraOptions,
