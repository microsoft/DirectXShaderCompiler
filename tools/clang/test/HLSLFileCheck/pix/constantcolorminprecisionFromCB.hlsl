...
// From-constant-buffer mode against a min16float SV_Target0 at ps_6_0
// without -enable-16bit-types. The tools constant buffer is four 32-bit
// components; loaded values narrow to half.
