...
_Static_assert(std::is_same<min16float, __decltype(bools % min16floats)>::value, "");    /* expected-warning {{min16float is promoted to float16_t}} */
_Static_assert(std::is_same<min10float, __decltype(bools % min10floats)>::value, "");    /* expected-warning {{min10float is promoted to float16_t}} fxc-pass {{}} */
_Static_assert(std::is_same<min16int, __decltype(bools % min16ints)>::value, "");   /* expected-error {{signed integer division is not supported on minimum-precision types, cast to int to use 32-bit division}} expected-warning {{min16int is promoted to int16_t}} fxc-pass {{}} */
_Static_assert(std::is_same<min12int, __decltype(bools % min12ints)>::value, "");   /* expected-error {{signed integer division is not supported on minimum-precision types, cast to int to use 32-bit division}} expected-warning {{min12int is promoted to int16_t}} fxc-pass {{}} */
_Static_assert(std::is_same<min16uint, __decltype(bools % min16uints)>::value, ""); /* expected-warning {{min16uint is promoted to uint16_t}} */
_Static_assert(std::is_same<int16_t, __decltype(bools % int16_ts)>::value, ""); 
_Static_assert(std::is_same<int32_t, __decltype(bools % int32_ts)>::value, "");
_Static_assert(std::is_same<int64_t, __decltype(bools % int64_ts)>::value, "");
