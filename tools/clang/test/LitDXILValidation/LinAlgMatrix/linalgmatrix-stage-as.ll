...
; CHECK-NEXT: Function: mainAS: error: Opcode LinAlgMatrixMultiply not valid in shader model as_6_10.
...
define void @mainAS() {
  ...
  %3 = alloca %struct.AmpPayload.0, align 8
  ...
  %5 = call %dx.types.LinAlgMatrixC8M16N16U0S0 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S0(i32 325, %dx.types.Handle %4, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %6 = call <16 x half> @dx.op.linAlgMatVecMul.v16f16.mC8M16N16U0S0.v16f16(i32 336, %dx.types.LinAlgMatrixC8M16N16U0S0 %5, i1 true, <16 x half> zeroinitializer, i32 8)  ; LinAlgMatVecMul(matrix,isOutputSigned,inputVector,interpretation)
  %7 = call <16 x half> @dx.op.linAlgMatVecMulAdd.v16f16.mC8M16N16U0S0.v16f16.v16f16(i32 337, %dx.types.LinAlgMatrixC8M16N16U0S0 %5, i1 true, <16 x half> %6, i32 8, <16 x half> %6)  ; LinAlgMatVecMulAdd(matrix,isOutputSigned,inputVector,inputInterpretation,biasVector)
  %8 = call <4 x i32> @dx.op.linAlgConvert.v4i32.v16i32(i32 341, <16 x i32> zeroinitializer, i32 5, i32 21)  ; LinAlgConvert(inputVector,inputInterpretation,outputInterpretation)
  %9 = call %dx.types.LinAlgMatrixC8M16N16U2S0 @dx.op.linAlgMatrixOuterProduct.mC8M16N16U2S0.v16f16.v16f16(i32 340, i1 true, <16 x half> %7, <16 x half> %7)  ; LinAlgMatrixOuterProduct(isInputSigned,vectorA,vectorB)
  ...
  call void @dx.op.linAlgMatrixAccumulateToDescriptor.mC8M16N16U2S0(i32 338, %dx.types.LinAlgMatrixC8M16N16U2S0 %9, %dx.types.Handle %10, i32 0, i32 0, i32 4, i32 128)  ; LinAlgMatrixAccumulateToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 342, %dx.types.Handle %11, i32 0, i32 64, <16 x half> %7)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,vector)
  %12 = call %dx.types.Handle @dx.op.annotateHandle(i32 216, %dx.types.Handle %2, %dx.types.ResourceProperties { i32 11, i32 0 })  ; AnnotateHandle(res,props)  resource: ByteAddressBuffer
  %13 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S1(i32 325, %dx.types.Handle %12, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %15 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U2S1(i32 325, %dx.types.Handle %14, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %16 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixAccumulate.mC8M16N16U2S1.mC8M16N16U2S1.mC8M16N16U0S1(i32 335, %dx.types.LinAlgMatrixC8M16N16U2S1 %15, %dx.types.LinAlgMatrixC8M16N16U0S1 %13)  ; LinAlgMatrixAccumulate(matrixLHS,matrixRHS)
  %17 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U2S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U2S1 %16)  ; LinAlgMatrixLength(matrix)
  %18 = call i32 @dx.op.linAlgMatrixQueryAccumulatorLayout(i32 333)  ; LinAlgMatrixQueryAccumulatorLayout()
  %19 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 323, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isInputSigned,value)
  %20 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U0S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U0S1 %19)  ; LinAlgMatrixLength(matrix)
  %21 = call <2 x i32> @dx.op.linAlgMatrixGetCoordinate.mC8M16N16U0S1(i32 328, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20)  ; LinAlgMatrixGetCoordinate(matrix,threadLocalIndex)
  %22 = call half @dx.op.linAlgMatrixGetElement.f16.mC8M16N16U0S1(i32 329, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20)  ; LinAlgMatrixGetElement(matrix,threadLocalIndex)
  %23 = fadd fast half %22, 0xH3CEC
  %24 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixSetElement.mC8M16N16U0S1.mC8M16N16U0S1.f16(i32 330, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20, half %23)  ; LinAlgMatrixSetElement(matrix,threadLocalIndex,value)
  %25 = call %dx.types.LinAlgMatrixC8M16N16U1S1 @dx.op.linAlgMatrixLoadFromMemory.mC8M16N16U1S1.i32(i32 326, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
  %26 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiply.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1(i32 334, %dx.types.LinAlgMatrixC8M16N16U0S1 %24, %dx.types.LinAlgMatrixC8M16N16U1S1 %25)  ; LinAlgMatrixMultiply(matrixA,matrixB)
  %27 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiplyAccumulate.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1.mC8M16N16U2S1(i32 322, %dx.types.LinAlgMatrixC8M16N16U0S1 %24, %dx.types.LinAlgMatrixC8M16N16U1S1 %25, %dx.types.LinAlgMatrixC8M16N16U2S1 %26)  ; LinAlgMatrixMultiplyAccumulate(matrixA,matrixB,matrixC)
  %28 = call %dx.types.Handle @dx.op.annotateHandle(i32 216, %dx.types.Handle %1, %dx.types.ResourceProperties { i32 4107, i32 0 })  ; AnnotateHandle(res,props)  resource: RWByteAddressBuffer
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M16N16U2S1(i32 331, %dx.types.LinAlgMatrixC8M16N16U2S1 %27, %dx.types.Handle %28, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  call void @dx.op.linAlgMatrixStoreToMemory.mC8M16N16U2S1.i32(i32 332, %dx.types.LinAlgMatrixC8M16N16U2S1 %27, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  %29 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgCopyConvertMatrix.mC8M16N16U2S1.mC8M16N16U1S1(i32 324, %dx.types.LinAlgMatrixC8M16N16U1S1 %25, i1 false)  ; LinAlgCopyConvertMatrix(srcMatrix,transpose)
  call void @dx.op.linAlgMatrixAccumulateToMemory.mC8M16N16U2S1.i32(i32 339, %dx.types.LinAlgMatrixC8M16N16U2S1 %29, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixAccumulateToMemory(matrix,memory,offset,stride,layout)
  %30 = bitcast %struct.AmpPayload.0* %3 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %30) #0
  %31 = getelementptr inbounds %struct.AmpPayload.0, %struct.AmpPayload.0* %3, i32 0, i32 0, i32 0
  store float 1.000000e+00, float* %31, align 8
  %32 = getelementptr inbounds %struct.AmpPayload.0, %struct.AmpPayload.0* %3, i32 0, i32 0, i32 1
  store float 2.000000e+00, float* %32, align 4
  call void @dx.op.dispatchMesh.struct.AmpPayload.0(i32 173, i32 8, i32 1, i32 1, %struct.AmpPayload.0* nonnull %3)  ; DispatchMesh(threadGroupCountX,threadGroupCountY,threadGroupCountZ,payload)
  call void @llvm.lifetime.end(i64 8, i8* %30) #0
  ret void
}
