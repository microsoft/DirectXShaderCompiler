...
// CHECK: [[sampler:%[0-9]+]] = OpLoad [[sampler_t]] [[ptr]]
  ...
  // TODO(issues/6649): Seems like DXC allows loading textures from the sampler heap.
  //                    This is fine for SPIR-V since we share the same descriptor anyway,
  //                    but maybe that's an incorrect behavior.
