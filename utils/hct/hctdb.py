...
class db_hlsl(object):
    ...
    def __init__(self, intrinsic_defs):
        self.base_types = {
            ...
            "any_object": "LICOMPTYPE_ANY_OBJECT",
            }
        self.trans_rowcol = {
            "r": "IA_R",
            "c": "IA_C",
            ...
            if type_matrix_match:
                ...
                if type_vector_match:
                    ...
                    if type_any_match:
                        ...
                        base_type = type_name
                        if base_type.startswith("sampler") or base_type.startswith("string") or base_type.startswith("Texture") or base_type.startswith("wave") or base_type.startswith("acceleration_struct") or base_type.startswith("ray_desc") or base_type.startswith("any_object"):
