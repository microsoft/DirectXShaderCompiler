...
//
// CHECK:    [[addr:%\d+]] = OpIAdd %uint [[addr0]] %uint_20
// CHECK: [[index_5:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
...
//
// CHECK:    [[addr:%\d+]] = OpIAdd %uint [[addr0]] %uint_24
// CHECK: [[index_6:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
...
//
// CHECK:     [[addr:%\d+]] = OpIAdd %uint [[addr0]] %uint_32
// CHECK:  [[index_8:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_8]]
// CHECK:  [[newAddr:%\d+]] = OpIAdd %uint [[addr0]] %uint_40
...
//
// CHECK: [[index_10:%\d+]] = OpShiftRightLogical %uint [[newAddr]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_10]]
// CHECK:    [[addr1:%\d+]] = OpIAdd %uint [[newAddr]] %uint_2
// CHECK: [[index_10:%\d+]] = OpShiftRightLogical %uint [[addr1]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_10]]
// CHECK:    [[addr2:%\d+]] = OpIAdd %uint [[addr1]] %uint_2
// CHECK: [[index_11:%\d+]] = OpShiftRightLogical %uint [[addr2]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_11]]
// CHECK:    [[addr3:%\d+]] = OpIAdd %uint [[addr2]] %uint_2
// CHECK:    [[aVec0:%\d+]] = OpCompositeConstruct %v3half
// CHECK: [[index_11:%\d+]] = OpShiftRightLogical %uint [[addr3]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_11]]
// CHECK:    [[addr4:%\d+]] = OpIAdd %uint [[addr3]] %uint_2
// CHECK: [[index_12:%\d+]] = OpShiftRightLogical %uint [[addr4]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_12]]
// CHECK:    [[addr5:%\d+]] = OpIAdd %uint [[addr4]] %uint_2
// CHECK: [[index_12:%\d+]] = OpShiftRightLogical %uint [[addr5]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_12]]
// CHECK:    [[addr6:%\d+]] = OpIAdd %uint [[addr5]] %uint_2
// CHECK:    [[aVec1:%\d+]] = OpCompositeConstruct %v3half
// CHECK: [[index_13:%\d+]] = OpShiftRightLogical %uint [[addr6]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_13]]
// CHECK:    [[addr7:%\d+]] = OpIAdd %uint [[addr6]] %uint_2
// CHECK: [[index_13:%\d+]] = OpShiftRightLogical %uint [[addr7]] %uint_2
// CHECK:      [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_13]]
// CHECK:    [[addr8:%\d+]] = OpIAdd %uint [[addr7]] %uint_2
// CHECK: [[index_14:%\d+]] = OpShiftRightLogical %uint [[addr8]] %uint_2
...
//
// CHECK: [[addr:%\d+]] = OpIAdd %uint [[newAddr]] %uint_20
// CHECK: [[index_15:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
...
// COMMENT: 'c' is 64-bit wide, so it will consume 2 words.
//
// CHECK: [[addr:%\d+]] = OpIAdd %uint [[newAddr]] %uint_24
// CHECK: [[index_16:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
...
//
// CHECK:     [[addr:%\d+]] = OpIAdd %uint [[newAddr]] %uint_32
// CHECK: [[index_18:%\d+]] = OpShiftRightLogical %uint [[addr]] %uint_2
