...
private:
  ...
  /// \brief Helper function to run passes based on SPIRV-Tools's infrastructure
  /// but only used for DXC. Returns whether running the passes succeeds or not.
  bool runSpirvOptPassesInDXC(std::vector<uint32_t> *mod);
