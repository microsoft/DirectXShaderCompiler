...
- Stripping reflection data now also strips struct, entry function, and groupshared variable names: [#7627](https://github.com/microsoft/DirectXShaderCompiler/issues/7627)
