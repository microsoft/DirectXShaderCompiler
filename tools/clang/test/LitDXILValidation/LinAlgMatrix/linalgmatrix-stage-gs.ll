...
define void @mainGS() {
  ...
  %6 = call %dx.types.LinAlgMatrixC8M16N16U0S0 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S0(i32 325, %dx.types.Handle %5, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %7 = call <16 x half> @dx.op.linAlgMatVecMul.v16f16.mC8M16N16U0S0.v16f16(i32 336, %dx.types.LinAlgMatrixC8M16N16U0S0 %6, i1 true, <16 x half> zeroinitializer, i32 8)  ; LinAlgMatVecMul(matrix,isOutputSigned,inputVector,interpretation)
  %8 = call <16 x half> @dx.op.linAlgMatVecMulAdd.v16f16.mC8M16N16U0S0.v16f16.v16f16(i32 337, %dx.types.LinAlgMatrixC8M16N16U0S0 %6, i1 true, <16 x half> %7, i32 8, <16 x half> %7)  ; LinAlgMatVecMulAdd(matrix,isOutputSigned,inputVector,inputInterpretation,biasVector)
  %9 = call <4 x i32> @dx.op.linAlgConvert.v4i32.v16i32(i32 341, <16 x i32> zeroinitializer, i32 5, i32 21)  ; LinAlgConvert(inputVector,inputInterpretation,outputInterpretation)
  %10 = call %dx.types.LinAlgMatrixC8M16N16U2S0 @dx.op.linAlgMatrixOuterProduct.mC8M16N16U2S0.v16f16.v16f16(i32 340, i1 true, <16 x half> %8, <16 x half> %8)  ; LinAlgMatrixOuterProduct(isInputSigned,vectorA,vectorB)
  ...
  call void @dx.op.linAlgMatrixAccumulateToDescriptor.mC8M16N16U2S0(i32 338, %dx.types.LinAlgMatrixC8M16N16U2S0 %10, %dx.types.Handle %11, i32 0, i32 0, i32 4, i32 128)  ; LinAlgMatrixAccumulateToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 342, %dx.types.Handle %12, i32 0, i32 64, <16 x half> %8)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,vector)
  ...
  %14 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S1(i32 325, %dx.types.Handle %13, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %16 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U2S1(i32 325, %dx.types.Handle %15, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %17 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixAccumulate.mC8M16N16U2S1.mC8M16N16U2S1.mC8M16N16U0S1(i32 335, %dx.types.LinAlgMatrixC8M16N16U2S1 %16, %dx.types.LinAlgMatrixC8M16N16U0S1 %14)  ; LinAlgMatrixAccumulate(matrixLHS,matrixRHS)
  %18 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U2S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U2S1 %17)  ; LinAlgMatrixLength(matrix)
  %19 = call i32 @dx.op.linAlgMatrixQueryAccumulatorLayout(i32 333)  ; LinAlgMatrixQueryAccumulatorLayout()
  %20 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 323, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isInputSigned,value)
  %21 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U0S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U0S1 %20)  ; LinAlgMatrixLength(matrix)
  %22 = call <2 x i32> @dx.op.linAlgMatrixGetCoordinate.mC8M16N16U0S1(i32 328, %dx.types.LinAlgMatrixC8M16N16U0S1 %20, i32 %21)  ; LinAlgMatrixGetCoordinate(matrix,threadLocalIndex)
  %23 = call half @dx.op.linAlgMatrixGetElement.f16.mC8M16N16U0S1(i32 329, %dx.types.LinAlgMatrixC8M16N16U0S1 %20, i32 %21)  ; LinAlgMatrixGetElement(matrix,threadLocalIndex)
  %24 = fadd fast half %23, 0xH3CEC
  %25 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixSetElement.mC8M16N16U0S1.mC8M16N16U0S1.f16(i32 330, %dx.types.LinAlgMatrixC8M16N16U0S1 %20, i32 %21, half %24)  ; LinAlgMatrixSetElement(matrix,threadLocalIndex,value)
  %26 = call %dx.types.LinAlgMatrixC8M16N16U1S1 @dx.op.linAlgMatrixLoadFromMemory.mC8M16N16U1S1.i32(i32 326, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
  %27 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiply.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1(i32 334, %dx.types.LinAlgMatrixC8M16N16U0S1 %25, %dx.types.LinAlgMatrixC8M16N16U1S1 %26)  ; LinAlgMatrixMultiply(matrixA,matrixB)
  %28 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiplyAccumulate.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1.mC8M16N16U2S1(i32 322, %dx.types.LinAlgMatrixC8M16N16U0S1 %25, %dx.types.LinAlgMatrixC8M16N16U1S1 %26, %dx.types.LinAlgMatrixC8M16N16U2S1 %27)  ; LinAlgMatrixMultiplyAccumulate(matrixA,matrixB,matrixC)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M16N16U2S1(i32 331, %dx.types.LinAlgMatrixC8M16N16U2S1 %28, %dx.types.Handle %29, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  call void @dx.op.linAlgMatrixStoreToMemory.mC8M16N16U2S1.i32(i32 332, %dx.types.LinAlgMatrixC8M16N16U2S1 %28, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  %30 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgCopyConvertMatrix.mC8M16N16U2S1.mC8M16N16U1S1(i32 324, %dx.types.LinAlgMatrixC8M16N16U1S1 %26, i1 false)  ; LinAlgCopyConvertMatrix(srcMatrix,transpose)
  call void @dx.op.linAlgMatrixAccumulateToMemory.mC8M16N16U2S1.i32(i32 339, %dx.types.LinAlgMatrixC8M16N16U2S1 %30, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixAccumulateToMemory(matrix,memory,offset,stride,layout)
