...
HRESULT CreateMSFileSystemForDisk(
    _COM_Outptr_ ::llvm::sys::fs::MSFileSystem **pResult) throw();
...
public:
  ...
  virtual BOOL
  FindNextFileW(_In_ HANDLE hFindFile,
                _Out_ LPWIN32_FIND_DATAW lpFindFileData) throw() override;
  virtual HANDLE
  FindFirstFileW(_In_ LPCWSTR lpFileName,
                 _Out_ LPWIN32_FIND_DATAW lpFindFileData) throw() override;
  virtual void FindClose(HANDLE findHandle) throw() override;
  virtual HANDLE CreateFileW(_In_ LPCWSTR lpFileName,
                             _In_ DWORD dwDesiredAccess, _In_ DWORD dwShareMode,
                             _In_ DWORD dwCreationDisposition,
                             _In_ DWORD dwFlagsAndAttributes) throw() override;
  virtual BOOL
  SetFileTime(_In_ HANDLE hFile, _In_opt_ const FILETIME *lpCreationTime,
              _In_opt_ const FILETIME *lpLastAccessTime,
              _In_opt_ const FILETIME *lpLastWriteTime) throw() override;
  virtual BOOL GetFileInformationByHandle(
      _In_ HANDLE hFile,
      _Out_ LPBY_HANDLE_FILE_INFORMATION lpFileInformation) throw() override;
  virtual DWORD GetFileType(_In_ HANDLE hFile) throw() override;
  virtual BOOL
  CreateHardLinkW(_In_ LPCWSTR lpFileName,
                  _In_ LPCWSTR lpExistingFileName) throw() override;
  virtual BOOL MoveFileExW(_In_ LPCWSTR lpExistingFileName,
                           _In_opt_ LPCWSTR lpNewFileName,
                           _In_ DWORD dwFlags) throw() override;
  ...
  _Success_(return != 0 && return < nBufferLength) virtual DWORD
      GetCurrentDirectoryW(_In_ DWORD nBufferLength,
                           _Out_writes_to_opt_(nBufferLength, return +1)
                               LPWSTR lpBuffer) throw() override;
  _Success_(return != 0 && return < nSize) virtual DWORD
      GetMainModuleFileNameW(__out_ecount_part(nSize, return +1)
                                 LPWSTR lpFilename,
                             DWORD nSize) throw() override;
  virtual DWORD GetTempPathW(DWORD nBufferLength,
                             _Out_writes_to_opt_(nBufferLength, return +1)
                                 LPWSTR lpBuffer) throw() override;
  virtual BOOLEAN CreateSymbolicLinkW(_In_ LPCWSTR lpSymlinkFileName,
                                      _In_ LPCWSTR lpTargetFileName,
                                      DWORD dwFlags) throw() override;
  virtual bool SupportsCreateSymbolicLink() throw() override;
  virtual BOOL ReadFile(_In_ HANDLE hFile,
                        _Out_bytecap_(nNumberOfBytesToRead) LPVOID lpBuffer,
                        _In_ DWORD nNumberOfBytesToRead,
                        _Out_opt_ LPDWORD lpNumberOfBytesRead) throw() override;
  virtual HANDLE
  CreateFileMappingW(_In_ HANDLE hFile, _In_ DWORD flProtect,
                     _In_ DWORD dwMaximumSizeHigh,
                     _In_ DWORD dwMaximumSizeLow) throw() override;
  virtual LPVOID
  MapViewOfFile(_In_ HANDLE hFileMappingObject, _In_ DWORD dwDesiredAccess,
                _In_ DWORD dwFileOffsetHigh, _In_ DWORD dwFileOffsetLow,
  ...
  virtual errno_t resize_file(_In_ LPCWSTR path,
                              uint64_t size) throw() override;
  virtual int Read(int fd, _Out_bytecap_(count) void *buffer,
                   unsigned int count) throw() override;
  virtual int Write(int fd, _In_bytecount_(count) const void *buffer,
                    unsigned int count) throw() override;
#ifndef _WIN32
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::FindNextFileW(
...
_Use_decl_annotations_ HANDLE MSFileSystemForDisk::FindFirstFileW(
...
_Use_decl_annotations_ HANDLE MSFileSystemForDisk::CreateFileW(
    LPCWSTR lpFileName, DWORD dwDesiredAccess, DWORD dwShareMode,
    DWORD dwCreationDisposition, DWORD dwFlagsAndAttributes) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::SetFileTime(
    HANDLE hFile, _In_opt_ const FILETIME *lpCreationTime,
    _In_opt_ const FILETIME *lpLastAccessTime,
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::GetFileInformationByHandle(
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::CreateHardLinkW(
    LPCWSTR lpFileName, LPCWSTR lpExistingFileName) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::MoveFileExW(
    LPCWSTR lpExistingFileName, LPCWSTR lpNewFileName, DWORD dwFlags) throw() {
#ifdef _WIN32
...
MSFileSystemForDisk::CloseHandle(HANDLE hObject) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOL
MSFileSystemForDisk::DeleteFileW(LPCWSTR lpFileName) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOL
MSFileSystemForDisk::RemoveDirectoryW(LPCWSTR lpFileName) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOL
MSFileSystemForDisk::CreateDirectoryW(LPCWSTR lpPathName) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ DWORD MSFileSystemForDisk::GetCurrentDirectoryW(
    DWORD nBufferLength, LPWSTR lpBuffer) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ DWORD MSFileSystemForDisk::GetMainModuleFileNameW(
    LPWSTR lpFilename, DWORD nSize) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ DWORD MSFileSystemForDisk::GetTempPathW(
    DWORD nBufferLength, LPWSTR lpBuffer) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ BOOLEAN MSFileSystemForDisk::CreateSymbolicLinkW(
...
_Use_decl_annotations_ BOOL MSFileSystemForDisk::ReadFile(
    HANDLE hFile, LPVOID lpBuffer, DWORD nNumberOfBytesToRead,
    _Out_opt_ LPDWORD lpNumberOfBytesRead) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ HANDLE MSFileSystemForDisk::CreateFileMappingW(
    HANDLE hFile, DWORD flProtect, DWORD dwMaximumSizeHigh,
...
_Use_decl_annotations_ LPVOID MSFileSystemForDisk::MapViewOfFile(
...
_Use_decl_annotations_ BOOL
MSFileSystemForDisk::UnmapViewOfFile(LPCVOID lpBaseAddress) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ errno_t
MSFileSystemForDisk::resize_file(LPCWSTR path, uint64_t size) throw() {
#ifdef _WIN32
...
MSFileSystemForDisk::Read(int fd, void *buffer, unsigned int count) throw() {
#ifdef _WIN32
...
_Use_decl_annotations_ int
MSFileSystemForDisk::Write(int fd, const void *buffer,
