...
; Make sure cbuffer reflection is correct with Flattened vector as array: [(rows*cols) x float]

%struct.S = type { [12 x i32], [2 x [3 x i32]], [3 x i32], [12 x i32], [2 x [3 x i32]], [3 x i32] }
