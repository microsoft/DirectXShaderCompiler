...
void main() {
  ...
  // CHECK: call void @dx.op.matrixLoadFromDescriptor(i32 -2147483634, %dx.types.MatrixRef %{{.*}}, %dx.types.Handle %{{.*}}, i32 1, i32 1, i32 0)  ; MatrixLoadFromDescriptor(matrix,handle,offset,stride,layout)
