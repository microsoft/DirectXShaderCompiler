...
168 AllocateRayQuery                               allocates space for RayQuery and return handle
169 RayQuery_TraceRayInline                        initializes RayQuery for raytrace
170 RayQuery_Proceed                               advances a ray query
171 RayQuery_Abort                                 aborts a ray query
172 RayQuery_CommitNonOpaqueTriangleHit            commits a non opaque triangle hit
173 RayQuery_CommitProceduralPrimitiveHit          commits a procedural primitive hit
174 RayQuery_CommittedStatus                       returns uint status (COMMITTED_STATUS) of the committed hit in a ray query
175 RayQuery_CandidateType                         returns uint candidate type (CANDIDATE_TYPE) of the current hit candidate in a ray query, after Proceed() has returned true
176 RayQuery_CandidateObjectToWorld3x4             returns matrix for transforming from object-space to world-space for a candidate hit.
177 RayQuery_CandidateWorldToObject3x4             returns matrix for transforming from world-space to object-space for a candidate hit.
178 RayQuery_CommittedObjectToWorld3x4             returns matrix for transforming from object-space to world-space for a Committed hit.
179 RayQuery_CommittedWorldToObject3x4             returns matrix for transforming from world-space to object-space for a Committed hit.
180 RayQuery_CandidateProceduralPrimitiveNonOpaque returns if current candidate procedural primitive is non opaque
181 RayQuery_CandidateTriangleFrontFace            returns if current candidate triangle is front facing
182 RayQuery_CommittedTriangleFrontFace            returns if current committed triangle is front facing
183 RayQuery_CandidateTriangleBarycentrics         returns candidate triangle hit barycentrics
184 RayQuery_CommittedTriangleBarycentrics         returns committed triangle hit barycentrics
185 RayQuery_RayFlags                              returns ray flags
186 RayQuery_WorldRayOrigin                        returns world ray origin
187 RayQuery_WorldRayDirection                     returns world ray direction
188 RayQuery_RayTMin                               returns float representing the parametric starting point for the ray.
189 RayQuery_CandidateTriangleRayT                 returns float representing the parametric point on the ray for the current candidate triangle hit.
190 RayQuery_CommittedRayT                         returns float representing the parametric point on the ray for the current committed hit.
191 RayQuery_CandidateInstanceIndex                returns candidate hit instance index
192 RayQuery_CandidateInstanceID                   returns candidate hit instance ID
193 RayQuery_CandidateGeometryIndex                returns candidate hit geometry index
194 RayQuery_CandidatePrimitiveIndex               returns candidate hit geometry index
195 RayQuery_CandidateObjectRayOrigin              returns candidate hit object ray origin
196 RayQuery_CandidateObjectRayDirection           returns candidate object ray direction
197 RayQuery_CommittedInstanceIndex                returns committed hit instance index
198 RayQuery_CommittedInstanceID                   returns committed hit instance ID
199 RayQuery_CommittedGeometryIndex                returns committed hit geometry index
200 RayQuery_CommittedPrimitiveIndex               returns committed hit geometry index
201 RayQuery_CommittedObjectRayOrigin              returns committed hit object ray origin
202 RayQuery_CommittedObjectRayDirection           returns committed object ray direction
203 GeometryIndex                                  The autogenerated index of the current geometry in the bottom-level structure
=== ============================================== =======================================================================================================================================================================================================================
