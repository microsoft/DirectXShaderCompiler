...
class db_dxil(object):
    ...
    def populate_dxil_operations(self):
        add_dxil_op = self.add_dxil_op
        reserve_dxil_op_range = self.reserve_dxil_op_range
        set_op_count_for_version = self.set_op_count_for_version
