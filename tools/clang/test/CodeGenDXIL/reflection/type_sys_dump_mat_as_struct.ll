...
; Make sure cbuffer reflection is correct with high level struct: %class.matrix.int.4.3 = type { [4 x <3 x i32>] }

%struct.S = type { %class.matrix.int.4.3, [2 x %class.matrix.int.1.3], %class.matrix.int.3.1, %class.matrix.int.4.3, [2 x %class.matrix.int.1.3], %class.matrix.int.3.1 }
