...
entry:
  ...
  %1 = call %dx.types.HitObject* @"dx.hl.op..%dx.types.HitObject* (i32, %dx.types.HitObject*)"(i32 328, %dx.types.HitObject* %hit), !dbg !23 ; line:9 col:17
  call void @"dx.hl.op..void (i32, %dx.types.HitObject*)"(i32 329, %dx.types.HitObject* %hit), !dbg !24 ; line:10 col:3
  call void @"dx.hl.op..void (i32, %dx.types.HitObject*, i32, i32)"(i32 329, %dx.types.HitObject* %hit, i32 241, i32 3), !dbg !25 ; line:11 col:3
  call void @"dx.hl.op..void (i32, i32, i32)"(i32 329, i32 242, i32 7), !dbg !26 ; line:12 col:3
