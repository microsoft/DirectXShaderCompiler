...
// ------------------------------------------------------------------
// CHECK: [[ATTRS0]] = !{
// CHECK-SAME: i32 8, i32 15, i32 13, i32 1, i32 14, i1 true, i32 15, [[NODEID0:![0-9]+]], i32 16, i32 -1, i32 18, [[DISPATCHGRID:![0-9]+]], i32 20, {{![0-9]+}}, i32 4, [[NUMTHREADS:![0-9]+]]
// CHECK-SAME: }
...
// ------------------------------------------------------------------
// CHECK: [[ATTRS1]] = !{
// CHECK-SAME: i32 8, i32 15, i32 13, i32 1, i32 14, i1 true, i32 15, [[NODEID1:![0-9]+]], i32 16, i32 -1, i32 18, [[DISPATCHGRID]], i32 20, {{![0-9]+}}, i32 4, [[NUMTHREADS]]
// CHECK-SAME: }
