...
namespace DXIL {
  ...
  enum class OpCode : unsigned {
    ...
    GeometryIndex = 203, // The autogenerated index of the current geometry in the bottom-level structure
    ...
    NumOpCodes_Dxil_1_5 = 204,
  
    NumOpCodes = 204 // exclusive last value of enumeration
  };
  // OPCODE-ENUM:END
