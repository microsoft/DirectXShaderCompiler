...
const OP::OpCodeProperty OP::m_OpCodeProps[(unsigned)OP::OpCode::NumOpCodes] = {
    ...
    //   i16,   i32,   i64,   udt,   obj,   vec,   ext,  function attribute, ext
    //   oload, vec oload
    ...
    // udt,   obj,   vec,  function attribute, ext oload, vec oload
    {OC::FAbs,
     "FAbs",
     OCC::Unary,
     "unary",
    ...
    // i32,   i64,   udt,   obj,   vec,  function attribute, ext oload, vec
    // oload
    {OC::Round_ne,
     "Round_ne",
     OCC::Unary,
    ...
    // i16,   i32,   i64,   udt,   obj,   vec,  function attribute, ext oload,
    // vec oload
    {OC::UMul,
     "UMul",
     OCC::BinaryWithTwoOuts,
    ...
    // i64,   udt,   obj,   vec,  function attribute, ext oload, vec oload
    {OC::FMad,
     "FMad",
     OCC::Tertiary,
     "tertiary",
    ...
    // obj,   vec,  function attribute, ext oload, vec oload
    {OC::Dot2,
     "Dot2",
     OCC::Dot2,
     "dot2",
    ...
    // i8,   i16,   i32,   i64,   udt,   obj,   vec,  function attribute, ext
    // oload, vec oload
    {OC::ThreadId,
     "ThreadId",
     OCC::ThreadId,
    ...
    // function attribute, ext oload, vec oload
    ...
    //                                                                                                                         void,     h,     f,     d,    i1,    i8,   i16,   i32,   i64,   udt,   obj,   vec,  function attribute, ext oload, vec oload
    {OC::Reserved0,
     "Reserved0",
     OCC::Reserved,
     "reserved",
