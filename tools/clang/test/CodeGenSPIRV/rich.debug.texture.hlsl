...
//CHECK: [[t0_ty:%\d+]] = OpExtInst %void [[ext]] DebugTypeComposite [[name_2d]] Class [[src:%\d+]] 0 0 [[cu:%\d+]] {{%\d+}} [[info_none]]
...
//CHECK: [[t3_ty:%\d+]] = OpExtInst %void [[ext]] DebugTypeComposite [[name_2d_arr]] Class [[src]] 0 0 [[cu]] {{%\d+}} [[info_none]]
