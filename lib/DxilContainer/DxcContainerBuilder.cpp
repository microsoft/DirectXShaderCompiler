...
HRESULT DxilLibCreateInstance(_In_ REFCLSID rclsid,
                              _In_ TInterface **ppInterface);
...
HRESULT STDMETHODCALLTYPE DxcContainerBuilder::AddPart(_In_ UINT32 fourCC,
...
DxcContainerBuilder::SerializeContainer(_Out_ IDxcOperationResult **ppResult) {
  DxcThreadMalloc TM(m_pMalloc);
  try {
