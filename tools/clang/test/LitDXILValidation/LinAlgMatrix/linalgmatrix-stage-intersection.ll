...
; CHECK: Function: {{.*}}mainIS{{.*}}: error: Thread Group Shared Memory not supported from non-compute entry points.
...
define void @"\01?mainIS@@YAXXZ"() #0 {
  %1 = load %dx.types.Handle, %dx.types.Handle* @"\01?InBuf@@3UByteAddressBuffer@@A", align 4, !noalias !18
  ...
  call void @dx.op.linAlgMatrixAccumulateToDescriptor.mC8M16N16U2S0(i32 338, %dx.types.LinAlgMatrixC8M16N16U2S0 %9, %dx.types.Handle %11, i32 0, i32 0, i32 4, i32 128)  ; LinAlgMatrixAccumulateToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 342, %dx.types.Handle %13, i32 0, i32 64, <16 x half> %7)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,vector)
  ...
  %16 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S1(i32 325, %dx.types.Handle %15, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %19 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U2S1(i32 325, %dx.types.Handle %18, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %20 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixAccumulate.mC8M16N16U2S1.mC8M16N16U2S1.mC8M16N16U0S1(i32 335, %dx.types.LinAlgMatrixC8M16N16U2S1 %19, %dx.types.LinAlgMatrixC8M16N16U0S1 %16)  ; LinAlgMatrixAccumulate(matrixLHS,matrixRHS)
  %21 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U2S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U2S1 %20)  ; LinAlgMatrixLength(matrix)
  %22 = call i32 @dx.op.linAlgMatrixQueryAccumulatorLayout(i32 333)  ; LinAlgMatrixQueryAccumulatorLayout()
  %23 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 323, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isInputSigned,value)
  %24 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U0S1(i32 327, %dx.types.LinAlgMatrixC8M16N16U0S1 %23)  ; LinAlgMatrixLength(matrix)
  %25 = call <2 x i32> @dx.op.linAlgMatrixGetCoordinate.mC8M16N16U0S1(i32 328, %dx.types.LinAlgMatrixC8M16N16U0S1 %23, i32 %24)  ; LinAlgMatrixGetCoordinate(matrix,threadLocalIndex)
  %26 = call half @dx.op.linAlgMatrixGetElement.f16.mC8M16N16U0S1(i32 329, %dx.types.LinAlgMatrixC8M16N16U0S1 %23, i32 %24)  ; LinAlgMatrixGetElement(matrix,threadLocalIndex)
  %27 = fadd fast half %26, 0xH3CEC
  %28 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixSetElement.mC8M16N16U0S1.mC8M16N16U0S1.f16(i32 330, %dx.types.LinAlgMatrixC8M16N16U0S1 %23, i32 %24, half %27)  ; LinAlgMatrixSetElement(matrix,threadLocalIndex,value)
  %29 = call %dx.types.LinAlgMatrixC8M16N16U1S1 @dx.op.linAlgMatrixLoadFromMemory.mC8M16N16U1S1.i32(i32 326, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
  %30 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiply.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1(i32 334, %dx.types.LinAlgMatrixC8M16N16U0S1 %28, %dx.types.LinAlgMatrixC8M16N16U1S1 %29)  ; LinAlgMatrixMultiply(matrixA,matrixB)
  %31 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiplyAccumulate.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1.mC8M16N16U2S1(i32 322, %dx.types.LinAlgMatrixC8M16N16U0S1 %28, %dx.types.LinAlgMatrixC8M16N16U1S1 %29, %dx.types.LinAlgMatrixC8M16N16U2S1 %30)  ; LinAlgMatrixMultiplyAccumulate(matrixA,matrixB,matrixC)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M16N16U2S1(i32 331, %dx.types.LinAlgMatrixC8M16N16U2S1 %31, %dx.types.Handle %33, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  call void @dx.op.linAlgMatrixStoreToMemory.mC8M16N16U2S1.i32(i32 332, %dx.types.LinAlgMatrixC8M16N16U2S1 %31, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  %34 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgCopyConvertMatrix.mC8M16N16U2S1.mC8M16N16U1S1(i32 324, %dx.types.LinAlgMatrixC8M16N16U1S1 %29, i1 false)  ; LinAlgCopyConvertMatrix(srcMatrix,transpose)
  call void @dx.op.linAlgMatrixAccumulateToMemory.mC8M16N16U2S1.i32(i32 339, %dx.types.LinAlgMatrixC8M16N16U2S1 %34, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixAccumulateToMemory(matrix,memory,offset,stride,layout)
  ret void
}
...
!15 = !{void ()* @"\01?mainIS@@YAXXZ", !"\01?mainIS@@YAXXZ", null, null, !16}
!16 = !{i32 8, i32 8, i32 5, !17}
!17 = !{i32 0}
!18 = !{!19}
