...
DxilSignatureAllocator::PackOptimized(std::vector<PackElement *> elements,
  ...
  //    preventing good packing
  //      for example: 2, 1, 2, 3 - total 8 components and packable, but if
  //      greedily packed, it will fail Packing largest to smallest would solve
  //      this.
  ...
  //  allocator
  //    with existing contents and trying to pack all elements into the
  //    remaining space.
