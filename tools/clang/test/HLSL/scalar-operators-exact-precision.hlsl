...
_Static_assert(std::is_same<half, __decltype(bools + min16floats)>::value, "");    /* fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(bools + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(ints + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(uints + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min16floats + bools)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min16floats + min16floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16floats + min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16floats + min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16floats + min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16floats + min16uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min10floats + bools)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min10floats + min16floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + int16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + int32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + int64_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + uint16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + uint32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min10floats + uint64_ts)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min16ints + min16floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16ints + min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints + min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints + min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16ints + min16uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min12ints + min16floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min12ints + min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints + min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints + min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min12ints + min16uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(min16uints + min16floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<half, __decltype(min16uints + min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints + min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints + min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints + min16uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(int16_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(int32_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(int64_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(uint16_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(uint32_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(uint64_ts + min10floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<half, __decltype(float16_ts + min16floats)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<float32_t, __decltype(min16ints / float32_ts)>::value, "");
_Static_assert(std::is_same<float64_t, __decltype(min16ints / float64_ts)>::value, "");
_Static_assert(std::is_same<int16_t, __decltype(min12ints / bools)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int, __decltype(min12ints / ints)>::value, "");
_Static_assert(std::is_same<uint, __decltype(min12ints / uints)>::value, "");
_Static_assert(std::is_same<half, __decltype(min12ints / halfs)>::value, "");
_Static_assert(std::is_same<float, __decltype(min12ints / floats)>::value, "");
...
_Static_assert(std::is_same<int16_t, __decltype(min12ints / min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min12ints / min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints / int16_ts)>::value, "");    /* fxc-pass {{}} */
_Static_assert(std::is_same<int32_t, __decltype(min12ints / int32_ts)>::value, "");
_Static_assert(std::is_same<int64_t, __decltype(min12ints / int64_ts)>::value, "");
_Static_assert(std::is_same<uint16_t, __decltype(min12ints / uint16_ts)>::value, "");
_Static_assert(std::is_same<uint32_t, __decltype(min12ints / uint32_ts)>::value, "");
...
_Static_assert(std::is_same<half, __decltype(int16_ts / min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(int16_ts / min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(int16_ts / min12ints)>::value, "");    /* fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(int16_ts / min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(int16_ts / int16_ts)>::value, "");
_Static_assert(std::is_same<int32_t, __decltype(int16_ts / int32_ts)>::value, "");
_Static_assert(std::is_same<int64_t, __decltype(int16_ts / int64_ts)>::value, "");
...
_Static_assert(std::is_same<half, __decltype(min12ints % min10floats)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints % min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints % min12ints)>::value, "");    /*  fxc-error {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min12ints % min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints % int16_ts)>::value, "");    /* fxc-pass {{}} */
_Static_assert(std::is_same<int32_t, __decltype(min12ints % int32_ts)>::value, "");
_Static_assert(std::is_same<int64_t, __decltype(min12ints % int64_ts)>::value, "");
...
_Static_assert(std::is_same<int16_t, __decltype(min16ints << bools)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<int16_t, __decltype(min16ints << min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << int16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << int32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << int64_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << uint16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << uint32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min16ints << uint64_ts)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<int16_t, __decltype(min12ints << bools)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<int16_t, __decltype(min12ints << min16ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << int16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << int32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << int64_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << uint16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << uint32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<int16_t, __decltype(min12ints << uint64_ts)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << bools)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << uints)>::value, "");    /*  fxc-pass {{}} */
...
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << min12ints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << min16uints)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << int16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << int32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << int64_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << uint16_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << uint32_ts)>::value, "");    /*  fxc-pass {{}} */
_Static_assert(std::is_same<uint16_t, __decltype(min16uints << uint64_ts)>::value, "");    /*  fxc-pass {{}} */
