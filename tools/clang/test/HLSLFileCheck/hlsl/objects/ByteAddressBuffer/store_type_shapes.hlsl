...
void main() {
  ...
  // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, {{.*}}, i32 108, i32 undef, i16 42, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
  ...
  // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, {{.*}}, i32 500, i32 undef, i16 42, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
  ...
  // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, {{.*}}, i32 600, i32 undef, i16 42, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
  ...
  // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, {{.*}}, i32 608, i32 undef, i16 42, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
