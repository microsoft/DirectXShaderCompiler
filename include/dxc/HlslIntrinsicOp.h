...
enum class IntrinsicOp {
  ...
  MOP_WorldRayOrigin,
  MOP_HitObject_FromRayQuery,
  MOP_HitObject_GetAttributes,
  MOP_HitObject_GetGeometryIndex,
  MOP_HitObject_GetHitKind,
  MOP_HitObject_GetInstanceID,
  MOP_HitObject_GetInstanceIndex,
  MOP_HitObject_GetObjectRayDirection,
  MOP_HitObject_GetObjectRayOrigin,
  MOP_HitObject_GetObjectToWorld3x4,
  MOP_HitObject_GetObjectToWorld4x3,
  MOP_HitObject_GetPrimitiveIndex,
  MOP_HitObject_GetRayFlags,
  MOP_HitObject_GetRayTCurrent,
  MOP_HitObject_GetRayTMin,
  MOP_HitObject_GetShaderTableIndex,
  MOP_HitObject_GetWorldRayDirection,
  MOP_HitObject_GetWorldRayOrigin,
  MOP_HitObject_GetWorldToObject3x4,
  MOP_HitObject_GetWorldToObject4x3,
  MOP_HitObject_Invoke,
  MOP_HitObject_IsHit,
  MOP_HitObject_IsMiss,
  MOP_HitObject_IsNop,
  MOP_HitObject_LoadLocalRootTableConstant,
  MOP_HitObject_MakeMiss,
  MOP_HitObject_MakeNop,
  MOP_HitObject_SetShaderTableIndex,
  MOP_HitObject_TraceRay,
  MOP_Count,
