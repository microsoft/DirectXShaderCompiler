...
``min16float`` ``-enable-16bit-types`` ``OpTypeFloat 16`` ``RelaxedPrecision``  ``Float16`` ``SPV_AMD_gpu_shader_half_float``
``min10float`` ``-enable-16bit-types`` ``OpTypeFloat 16`` ``RelaxedPrecision``  ``Float16`` ``SPV_AMD_gpu_shader_half_float``
``min16int``   ``-enable-16bit-types`` ``OpTypeInt 16 1`` ``RelaxedPrecision``  ``Int16``
``min12int``   ``-enable-16bit-types`` ``OpTypeInt 16 1`` ``RelaxedPrecision``  ``Int16``
``min16uint``  ``-enable-16bit-types`` ``OpTypeInt 16 0`` ``RelaxedPrecision``  ``Int16``
============== ======================= ================== ==================== ============ =================================
