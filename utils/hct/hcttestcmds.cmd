...
call :check_file -use-absolute-path "%testfiles%\dump_dependency.d" find dump_dependency.hlsl find dependency0.h find dependency1.h find dependency2.h find dependency3.h find dependency4.h find dependency5.h del
if %Failed% neq 0 goto :failed
...
) else if "%1"=="-use-absolute-path" (
  set check_file_pattern=%2
  shift /1
) else (
  set check_file_pattern=%CD%\%1
)
