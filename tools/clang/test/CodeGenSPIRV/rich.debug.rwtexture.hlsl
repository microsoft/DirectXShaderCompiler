...
//CHECK: [[1di:%\d+]] = OpExtInst %void [[ext:%\d+]] DebugTypeComposite [[name_1d]] Class [[src:%\d+]] 0 0 [[cu:%\d+]] {{%\d+}} [[info_none:%\d+]]
...
//CHECK: [[2daf:%\d+]] = OpExtInst %void [[ext]] DebugTypeComposite [[name_2d_arr]] Class [[src]] 0 0 [[cu]] {{%\d+}} [[info_none]]
