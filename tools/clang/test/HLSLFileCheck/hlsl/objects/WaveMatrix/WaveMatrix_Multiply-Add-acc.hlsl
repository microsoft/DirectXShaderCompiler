...
// CHECK: %[[wma2:.*]] = alloca %dx.types.waveMatrix, align 4
...
// CHECK: call void @dx.op.waveMatrix_Annotate(i32 226, %dx.types.waveMatrix* nonnull %[[wma2]], %dx.types.waveMatProps { i8 4, i8 [[COMP]], i32 [[DIMM]], i32 [[DIMN]] })
  WML left;
  WMR right;
  WMLC leftcol;
  WMRR rightrow;
...
// CHECK: call void @dx.op.waveMatrix_Multiply(i32 233, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wml]], %dx.types.waveMatrix* nonnull %[[wmr]])
// CHECK: call void @dx.op.waveMatrix_Multiply(i32 234, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wml]], %dx.types.waveMatrix* nonnull %[[wmr]])
  acc.Multiply(left, right);
  acc.MultiplyAccumulate(left, right);

// CHECK: call void @dx.op.waveMatrix_Accumulate(i32 237, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wmlc]])
// CHECK: call void @dx.op.waveMatrix_Accumulate(i32 237, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wmrr]])
  acc.Add(leftcol);
  acc.Add(rightrow);

// CHECK: call void @dx.op.waveMatrix_Accumulate(i32 237, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wma2]])
// CHECK: call void @dx.op.waveMatrix_Accumulate(i32 237, %dx.types.waveMatrix* nonnull %[[wma]], %dx.types.waveMatrix* nonnull %[[wma]])
  acc.Add(acc2);
  acc.Add(acc);
}
