...
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 4
...
// CHECK-NEXT: HLSLMaxRecordsAttr 0x{{.*}}
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 4
// CHECK-NEXT: HLSLNodeIdAttr 0x{{.*}} "myNiftyNode"
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 3
...
// CHECK-NEXT: HLSLMaxRecordsAttr 0x{{.*}}
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 20
// CHECK-NEXT: CompoundStmt 0x
// CHECK-NEXT: HLSLNumThreadsAttr 0x{{.*}}
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 4
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 5
// CHECK-NEXT: IntegerLiteral 0x{{.*}} 6
