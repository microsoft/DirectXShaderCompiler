...
void DeserializeRootSignature(
    _In_reads_bytes_(SrcDataSizeInBytes) const void *pSrcData,
...
bool VerifyRootSignatureWithShaderPSV(
    _In_ const DxilVersionedRootSignatureDesc *pDesc,
    _In_ DXIL::ShaderKind ShaderKind,
    _In_reads_bytes_(PSVSize) const void *pPSVData, _In_ uint32_t PSVSize,
