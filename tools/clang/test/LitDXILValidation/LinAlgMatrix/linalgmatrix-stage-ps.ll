...
; CHECK: Function: mainPS: error: Thread Group Shared Memory not supported from non-compute entry points.
...
; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixLoadFromMemory
; CHECK-NEXT: Function: mainPS: error: Opcode LinAlgMatrixMultiply not valid in shader model ps_6_10.
...
!14 = !{void ()* @mainPS, !"mainPS", !15, !8, !22}
!15 = !{!16, !19, null}
!16 = !{!17}
!17 = !{i32 0, !"SV_PrimitiveID", i8 5, i8 10, !18, i8 1, i32 1, i8 1, i32 0, i8 0, null}
!18 = !{i32 0}
!19 = !{!20}
!20 = !{i32 0, !"SV_Target", i8 9, i8 16, !18, i8 0, i32 1, i8 4, i32 0, i8 0, !21}
!21 = !{i32 3, i32 15}
!22 = !{i32 0, i64 2207621578800}
