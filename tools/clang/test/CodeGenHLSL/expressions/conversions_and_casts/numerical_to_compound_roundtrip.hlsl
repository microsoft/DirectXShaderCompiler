...
void main() {
    ...
    // CHECK: i32 1, i32 0, i32 0, i32 0,
    // CHECK: i32 1, i32 0, i32 0, i32 0,
    // CHECK: i32 8888, i32 8888, i32 8888, i32 8888,
    ...
    // Truncation case
    // CHECK: i32 1, i32 2, i32 0, i32 0,
    // CHECK: i32 11, i32 12, i32 13, i32 14,
    // CHECK: i32 1, i32 2, i32 0, i32 0,
    // CHECK: i32 11, i32 12, i32 13, i32 14,
    // CHECK: i32 8888, i32 8888, i32 8888, i32 8888,
    output_v2((int2)(s_three_ints)v4);
    output_m2x2((int2x2)(s_mat_3x3)m4x4);
    output_v2((int2)(a_three_ints)v4);
    output_m2x2((int2x2)(a_mat_3x3)m4x4);
    output_separator();
}