...
linear noperspective centroid center float2 g_lin_nop_cen_ctr;    /* expected-error {{'center' is not a valid modifier for a global variable}} expected-error {{'centroid' is not a valid modifier for a global variable}} expected-error {{'linear' is not a valid modifier for a global variable}} expected-error {{'noperspective' is not a valid modifier for a global variable}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
centroid center float2 g_cen_ctr;                           /* expected-error {{'center' is not a valid modifier for a global variable}} expected-error {{'centroid' is not a valid modifier for a global variable}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
typedef linear noperspective centroid center float2 t_lin_nop_cen_ctr;    /* expected-error {{'center' is not a valid modifier for a typedef}} expected-error {{'centroid' is not a valid modifier for a typedef}} expected-error {{'linear' is not a valid modifier for a typedef}} expected-error {{'noperspective' is not a valid modifier for a typedef}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-error {{X3000: syntax error: unexpected token 'linear'}} */
...
typedef centroid center float2 t_cen_ctr;                   /* expected-error {{'center' is not a valid modifier for a typedef}} expected-error {{'centroid' is not a valid modifier for a typedef}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-error {{X3000: syntax error: unexpected token 'centroid'}} */
...
struct s_interp_mods {
    ...
    linear sample noperspective centroid center float2 f_lin_sam_nop_cen_ctr;    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
    ...
    linear sample centroid center float2 f_lin_sam_cen_ctr; /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
    ...
    linear noperspective centroid center float2 f_lin_nop_cen_ctr;    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    linear noperspective center float2 f_lin_nop_ctr;
    linear centroid float2 f_lin_cen;
    linear centroid center float2 f_lin_cen_ctr;            /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    ...
    sample noperspective centroid center float2 f_sam_nop_cen_ctr;    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
    ...
    sample centroid center float2 f_sam_cen_ctr;            /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
    ...
    noperspective centroid center float2 f_nop_cen_ctr;     /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    noperspective center float2 f_nop_ctr;
    centroid float2 f_cen;
    centroid center float2 f_cen_ctr;                       /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    center float2 f_ctr;
    // GENERATED_CODE:END
};
...
float4 foo_lin_sam_nop_cen_ctr(linear sample noperspective centroid center float4 val) { return val; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
float4 foo_lin_sam_cen_ctr(linear sample centroid center float4 val) { return val; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
float4 foo_lin_nop_cen_ctr(linear noperspective centroid center float4 val) { return val; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
float4 foo_lin_cen_ctr(linear centroid center float4 val) { return val; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
float4 foo_sam_nop_cen_ctr(sample noperspective centroid center float4 val) { return val; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
float4 foo_sam_cen_ctr(sample centroid center float4 val) { return val; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
float4 foo_nop_cen_ctr(noperspective centroid center float4 val) { return val; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
float4 foo_nop_ctr(noperspective center float4 val) { return val; }
float4 foo_cen(centroid float4 val) { return val; }
float4 foo_cen_ctr(centroid center float4 val) { return val; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
void vain() {
    ...
    linear noperspective centroid center float3 l_lin_nop_cen_ctr;    /* expected-error {{'center' is not a valid modifier for a local variable}} expected-error {{'centroid' is not a valid modifier for a local variable}} expected-error {{'linear' is not a valid modifier for a local variable}} expected-error {{'noperspective' is not a valid modifier for a local variable}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    ...
    centroid center float3 l_cen_ctr;                       /* expected-error {{'center' is not a valid modifier for a local variable}} expected-error {{'centroid' is not a valid modifier for a local variable}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
linear sample noperspective centroid center float fn_lin_sam_nop_cen_ctr() { return 1.0f; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
linear sample centroid center float fn_lin_sam_cen_ctr() { return 1.0f; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
linear noperspective centroid center float fn_lin_nop_cen_ctr() { return 1.0f; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
linear noperspective center float fn_lin_nop_ctr() { return 1.0f; }
linear centroid float fn_lin_cen() { return 1.0f; }
linear centroid center float fn_lin_cen_ctr() { return 1.0f; }  /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
sample noperspective centroid center float fn_sam_nop_cen_ctr() { return 1.0f; }    /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
sample centroid center float fn_sam_cen_ctr() { return 1.0f; }  /* expected-warning {{'center' will be overridden by 'sample'}} expected-warning {{'centroid' will be overridden by 'center'}} expected-warning {{'centroid' will be overridden by 'sample'}} fxc-pass {{}} */
...
noperspective centroid center float fn_nop_cen_ctr() { return 1.0f; }    /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
noperspective center float fn_nop_ctr() { return 1.0f; }
centroid float fn_cen() { return 1.0f; }
centroid center float fn_cen_ctr() { return 1.0f; }             /* expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
...
class C
{
    ...
    linear noperspective centroid center float fn_lin_nop_cen_ctr() { return 1.0f; }    /* expected-error {{'center' is not a valid modifier for a method}} expected-error {{'centroid' is not a valid modifier for a method}} expected-error {{'linear' is not a valid modifier for a method}} expected-error {{'noperspective' is not a valid modifier for a method}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    ...
    linear centroid center float fn_lin_cen_ctr() { return 1.0f; }    /* expected-error {{'center' is not a valid modifier for a method}} expected-error {{'centroid' is not a valid modifier for a method}} expected-error {{'linear' is not a valid modifier for a method}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
    ...
    centroid center float fn_cen_ctr() { return 1.0f; }     /* expected-error {{'center' is not a valid modifier for a method}} expected-error {{'centroid' is not a valid modifier for a method}} expected-warning {{'centroid' will be overridden by 'center'}} fxc-pass {{}} */
