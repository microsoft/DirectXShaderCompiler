...
// Test the scenario where structure stride is not dword aligned
...
void main(uint i : IN0)
{
   ...
   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 12, i8 7, i32 2)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 %{{.*}}, i32 12, half %{{.*}}, half %{{.*}}, half %{{.*}}, half undef, i8 7, i32 2)
   uav0[i] = srv0[i];
   ...
   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 0, i32 12, i8 7, i32 4)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 0, i32 12, half %{{.*}}, half %{{.*}}, half %{{.*}}, half undef, i8 7, i32 4)
   uav0[0] = srv0[0];

   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 1, i32 0, i8 1, i32 2)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 1, i32 0, half %{{.*}}, half undef, half undef, half undef, i8 1, i32 2)

   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 1, i32 2, i8 3, i32 4)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 1, i32 2, half %{{.*}}, half %{{.*}}, half undef, half undef, i8 3, i32 4)

   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 1, i32 6, i8 7, i32 4)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 1, i32 6, half %{{.*}}, half %{{.*}}, half %{{.*}}, half undef, i8 7, i32 4)

   // CHECK: call %dx.types.ResRet.f16 @dx.op.rawBufferLoad.f16(i32 139, %dx.types.Handle %{{.*}}, i32 1, i32 12, i8 7, i32 2)
   // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %{{.*}}, i32 1, i32 12, half %{{.*}}, half %{{.*}}, half %{{.*}}, half undef, i8 7, i32 2)
   uav0[1] = srv0[1];
}
