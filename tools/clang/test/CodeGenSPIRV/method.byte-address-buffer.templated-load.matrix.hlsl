...
// CHECK:             [[index_2:%\d+]] = OpShiftRightLogical %uint [[addr1]] %uint_2
// CHECK:                 [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_2]]
// CHECK:               [[word2:%\d+]] = OpLoad %uint [[ptr]]
...
// CHECK:               [[addr2:%\d+]] = OpIAdd %uint [[addr1]] %uint_8
// CHECK:             [[index_4:%\d+]] = OpShiftRightLogical %uint [[addr2]] %uint_2
// CHECK:                 [[ptr:%\d+]] = OpAccessChain %_ptr_Uniform_uint %buf %uint_0 [[index_4]]
// CHECK:               [[word4:%\d+]] = OpLoad %uint [[ptr]]
...
// CHECK:               [[addr2:%\d+]] = OpIAdd %uint [[addr2]] %uint_8
// CHECK:             [[index_6:%\d+]] = OpShiftRightLogical %uint [[addr2]] %uint_2
