...
// RUiN: %dxc -DTYPE=bool4     -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,I1
...
// RUiN: %dxc -DTYPE=bool     -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,I1
...
// RUiN: %dxc -DTYPE=bool1     -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,I1
