...
void main()
{
  ...
  // CHK_TEST5: dx.op.rawBufferStore.f32
  // CHK_TEST5: i32 1, i32 undef, float 3.000000e+00, float 6.000000e+00
  ...
  // CHK_TEST6: dx.op.rawBufferStore.f32
  // CHK_TEST6: i32 1, i32 undef, float 4.000000e+00, float 6.000000e+00
  ...
  // CHK_TEST7: dx.op.rawBufferStore.f32
  // CHK_TEST7: i32 1, i32 undef, float 5.000000e+00, float 8.000000e+00, float 3.000000e+00, float 6.000000e+00
  // CHK_TEST7: dx.op.rawBufferStore.f32
  ...
  // CHK_TEST8: dx.op.rawBufferStore.f32
  // CHK_TEST8: i32 1, i32 undef, float 6.000000e+00, float 1.000000e+01, float 3.000000e+00, float 7.000000e+00
  // CHK_TEST8: dx.op.rawBufferStore.f32
  // CHK_TEST8: i32 2, i32 undef, float 1.100000e+01, float 4.000000e+00, float 8.000000e+00, float 1.200000e+01
  ...
  // CHK_TEST9: dx.op.rawBufferStore.f32
  // CHK_TEST9: i32 1, i32 undef, float 2.000000e+00, float 5.000000e+00, float 8.000000e+00, float 1.100000e+01
  // CHK_TEST9: dx.op.rawBufferStore.f32
  // CHK_TEST9: i32 2, i32 undef, float 3.000000e+00, float 6.000000e+00, float 9.000000e+00, float 1.200000e+01
  ...
  // CHK_TEST10: dx.op.rawBufferStore.f32
  // CHK_TEST10: i32 1, i32 undef, float 2.000000e+00, float 6.000000e+00, float 1.000000e+01, float 1.400000e+01
  // CHK_TEST10: dx.op.rawBufferStore.f32
  // CHK_TEST10: i32 2, i32 undef, float 3.000000e+00, float 7.000000e+00, float 1.100000e+01, float 1.500000e+01
  // CHK_TEST10: dx.op.rawBufferStore.f32
  // CHK_TEST10: i32 3, i32 undef, float 4.000000e+00, float 8.000000e+00, float 1.200000e+01, float 1.600000e+01
