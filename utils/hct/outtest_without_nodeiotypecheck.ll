...
; Function Attrs: nounwind readnone
declare %dx.types.NodeRecordHandle @"dx.hl.cast..%dx.types.NodeRecordHandle (i32, %\22struct.DispatchNodeInputRecord<loadStressRecord>\22)"(i32, %"struct.DispatchNodeInputRecord<loadStressRecord>") #2
...
; Function Attrs: nounwind readnone
declare %dx.types.NodeRecordHandle @"dx.hl.cast..%dx.types.NodeRecordHandle (i32, %\22struct.GroupNodeOutputRecords<loadStressRecord>\22)"(i32, %"struct.GroupNodeOutputRecords<loadStressRecord>") #2
...
; Function Attrs: nounwind readnone
declare %dx.types.NodeHandle @"dx.hl.cast..%dx.types.NodeHandle (i32, %\22struct.NodeOutput<loadStressRecord>\22)"(i32, %"struct.NodeOutput<loadStressRecord>") #2
...
; Function Attrs: nounwind readnone
declare %"struct.GroupNodeOutputRecords<loadStressRecord>" @"dx.hl.cast..%\22struct.GroupNodeOutputRecords<loadStressRecord>\22 (i32, %dx.types.NodeRecordHandle)"(i32, %dx.types.NodeRecordHandle) #2

; Function Attrs: nounwind
declare %dx.types.NodeRecordHandle @"dx.hl.createnodeinputrecordhandle..%dx.types.NodeRecordHandle (i32, i32)"(i32, i32) #0

; Function Attrs: nounwind readnone
declare %"struct.DispatchNodeInputRecord<loadStressRecord>" @"dx.hl.cast..%\22struct.DispatchNodeInputRecord<loadStressRecord>\22 (i32, %dx.types.NodeRecordHandle)"(i32, %dx.types.NodeRecordHandle) #2
...
attributes #1 = { nounwind readnone "dx.hlls"="DefaultSubscript" }
