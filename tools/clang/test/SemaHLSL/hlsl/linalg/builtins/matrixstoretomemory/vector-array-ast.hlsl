...
// CHECK: FunctionDecl {{.*}} implicit used __builtin_LinAlg_MatrixStoreToMemory 'void (__builtin_LinAlgMatrix {{.*}}, vector<float, 4> const __attribute__((address_space(3))) (&)[64], unsigned int, unsigned int, unsigned int)' extern
