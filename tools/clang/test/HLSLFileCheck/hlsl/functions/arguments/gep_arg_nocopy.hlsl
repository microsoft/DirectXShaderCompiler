...
// CHECK: [[a:%.+]] = getelementptr inbounds %"$Globals", %"$Globals"* {{%[0-9A-Z]+}}, i32 0, i32 0, i32 0
// CHECK: [[Tmpa:%.+]] = alloca [32 x <4 x float>]
// CHECK: [[TmpaPtr:%.+]] = bitcast [32 x <4 x float>]* [[Tmpa]] to i8*
// CHECK: [[aPtr:%.+]] = bitcast [32 x <4 x float>]* [[a]] to i8*
