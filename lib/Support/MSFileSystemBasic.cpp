...
struct MSFileSystemHandle {
  ...
  MSFileSystemHandle(int knownFD)
      : fd(knownFD), kind(MSFileSystemHandleKind_FileHandle) {}

  MSFileSystemHandle(IUnknown *pMapping)
      : storage(pMapping), kind(MSFileSystemHandleKind_FileMappingHandle),
        fd(0) {}

  MSFileSystemHandle(IUnknown *pStorage, IStream *pStream)
      : storage(pStorage), stream(pStream),
        kind(MSFileSystemHandleKind_FileHandle), fd(0) {}

  MSFileSystemHandle(IEnumSTATSTG *pEnumSTATG)
      : storage(pEnumSTATG), kind(MSFileSystemHandleKind_FindHandle) {}
