...
min16float left92; min10float right92; left92 = right92;  // expected-warning {{min10float is promoted to min16float}} expected-warning {{min16float is promoted to half}}
...
min12int left127; min16float right127; left127 = right127; // expected-warning {{conversion from larger type 'min16float' to smaller type 'min12int', possible loss of data}} expected-warning {{min12int is promoted to min16int}} expected-warning {{min16float is promoted to half}} fxc-warning {{X3205: conversion from larger type to smaller, possible loss of data}} //
...
// min16float left1067; unorm double right1067; left1067 = right1067;
 min16float left1068; snorm min16float right1068; left1068 = right1068;   /* expected-warning {{min16float is promoted to half}} */
 min16float left1069; unorm min16float right1069; left1069 = right1069;   /* expected-warning {{min16float is promoted to half}} */
 min16float left1070; snorm min10float right1070; left1070 = right1070;  // expected-warning {{min10float is promoted to min16float}} expected-warning {{min16float is promoted to half}}
 min16float left1071; unorm min10float right1071; left1071 = right1071;  // expected-warning {{min10float is promoted to min16float}} expected-warning {{min16float is promoted to half}}
...
snorm min16float left1078;  min16float right1078; left1078 = right1078;  /* expected-warning {{min16float is promoted to half}} */
...
unorm min16float left1090;  min16float right1090; left1090 = right1090;       /* expected-warning {{min16float is promoted to half}} */
