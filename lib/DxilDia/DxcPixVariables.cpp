...
public:
  ...
  STDMETHODIMP GetStorage(_COM_Outptr_ IDxcPixDxilStorage **ppStorage) override;
};
...
template <typename T>
STDMETHODIMP
dxil_debug_info::DxcPixVariable<T>::GetName(_Outptr_result_z_ BSTR *Name) {
...
STDMETHODIMP
dxil_debug_info::DxcPixDxilLiveVariables::GetCount(_Outptr_ DWORD *dwSize) {
...
STDMETHODIMP dxil_debug_info::DxcPixDxilLiveVariables::GetVariableByIndex(
    _In_ DWORD Index, _Outptr_result_z_ IDxcPixVariable **ppVariable) {
...
STDMETHODIMP dxil_debug_info::DxcPixDxilLiveVariables::GetVariableByName(
    _In_ LPCWSTR Name, _Outptr_result_z_ IDxcPixVariable **ppVariable) {
