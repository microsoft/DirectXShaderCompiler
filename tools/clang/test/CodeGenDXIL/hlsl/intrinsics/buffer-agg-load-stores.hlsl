...
// RUN: %dxc -DMAT -DTYPE=float    -DNUM=3 -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,MAT
// RUN: %dxc -DMAT -DTYPE=bool     -DNUM=3 -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,MAT
// RUN: %dxc -DMAT -DTYPE=uint64_t -DNUM=3 -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,MAT
// RUN: %dxc -DMAT -DTYPE=double   -DNUM=3 -T vs_6_6 %s | FileCheck %s --check-prefixes=CHECK,MAT

// RUN: %dxc -DTYPE=float    -DNUM=4 -T vs_6_6 %s | FileCheck %s
// RUN: %dxc -DTYPE=bool     -DNUM=4 -T vs_6_6 %s | FileCheck %s
// RUN: %dxc -DTYPE=uint64_t -DNUM=2 -T vs_6_6 %s | FileCheck %s
// RUN: %dxc -DTYPE=double   -DNUM=2 -T vs_6_6 %s | FileCheck %s
