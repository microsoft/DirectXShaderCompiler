...
; IRCHECK: !DIGlobalVariable(name: "g_xAxis.2", linkageName: "g_xAxis.2", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 19, type: ![[ConstUInt3Member2:[0-9]+]], isLocal: false, isDefinition: true, variable: i32* @g_xAxis.2)
; IRCHECK: !DIGlobalVariable(name: "g_yAxis.1", linkageName: "g_yAxis.1", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 20, type: ![[ConstUInt3Member1:[0-9]+]], isLocal: false, isDefinition: true, variable: i32* @g_yAxis.1)
; IRCHECK: !DIGlobalVariable(name: "g_yAxis.0", linkageName: "g_yAxis.0", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 20, type: ![[ConstUInt3Member0:[0-9]+]], isLocal: false, isDefinition: true, variable: i32* @g_yAxis.0)
...
; IRCHECK: !DIGlobalVariable(name: "g_gridResolution.1", linkageName: "g_gridResolution.1", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 23, type: ![[ConstUInt3Member1]], isLocal: false, isDefinition: true, variable: i32* @g_gridResolution.1)
; IRCHECK: !DIGlobalVariable(name: "g_gridResolution.0", linkageName: "g_gridResolution.0", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 23, type: ![[ConstUInt3Member0]], isLocal: false, isDefinition: true, variable: i32* @g_gridResolution.0)
...
; IRCHECK: !DIGlobalVariable(name: "g_gridResolution.2", linkageName: "g_gridResolution.2", scope: ![[DICompileUnit]], file: ![[DIFile]], line: 23, type: ![[ConstUInt3Member2]], isLocal: false, isDefinition: true, variable: i32* @g_gridResolution.2)
