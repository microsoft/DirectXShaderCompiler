...
// CHECK: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(gs).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainGS'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(ds).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainDS'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(hs).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainHS'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(vs).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainVS'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(ps).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainPS'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(miss).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainMS@@YAXURayPayload@@@Z'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(closesthit).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainCH@@YAXURayPayload@@UAttribs@@@Z'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(anyhit).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainAH@@YAXURayPayload@@UAttribs@@@Z'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(callable).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainCALL@@YAXUAttribs@@@Z'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(intersection).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainIS@@YAXXZ'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(raygeneration).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function '{{.*}}mainRG@@YAXXZ'.
// CHECK-NEXT: Opcode LinAlgMatrixSetElement not valid in shader model lib_6_10(node).
// CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixSetElement{{.*}} of function 'mainNS'.
