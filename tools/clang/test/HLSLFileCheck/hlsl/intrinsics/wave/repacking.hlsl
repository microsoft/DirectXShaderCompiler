...
[shader("miss")] void Miss(inout Payload p) {
  ...
  // CHECK: call i32 @dx.op.waveActiveOp.i32(i32 119, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 25
  // CHECK: call i32 @dx.op.waveActiveOp.i32(i32 119, i32
  RepackingPoint(24);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 26
  // CHECK: call i32 @dx.op.waveActiveOp.i32(i32 119, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 27
  // CHECK: call i32 @dx.op.waveActiveOp.i32(i32 119, i32
  RepackingPoint(26);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 28
  // CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 29
  // CHECK: call i32 @dx.op.wavePrefixOp.i32(i32 121, i32
  RepackingPoint(28);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 30
  // CHECK: call i64 @dx.op.wavePrefixOp.i64(i32 121, i64
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 31
  // CHECK: call i64 @dx.op.wavePrefixOp.i64(i32 121, i64
  RepackingPoint(30);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 32
  // CHECK: call i32 @dx.op.waveAllOp(i32 135, i1
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 33
  // CHECK: call i32 @dx.op.waveAllOp(i32 135, i1
  RepackingPoint(32);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 34
  // CHECK: call i32 @dx.op.wavePrefixOp(i32 136, i1
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 35
  // CHECK: call i32 @dx.op.wavePrefixOp(i32 136, i1
  RepackingPoint(34);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 36
  // CHECK: call %dx.types.fouri32 @dx.op.waveMatch.i32(i32 165, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 37
  // CHECK: call %dx.types.fouri32 @dx.op.waveMatch.i32(i32 165, i32
  RepackingPoint(36);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 38
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 39
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  RepackingPoint(38);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 40
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 41
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  RepackingPoint(40);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 42
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 43
  // CHECK: call i32 @dx.op.waveMultiPrefixOp.i32(i32 166, i32
  RepackingPoint(42);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 44
  // CHECK: call i32 @dx.op.waveMultiPrefixBitCount(i32 167, i1
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 45
  // CHECK: call i32 @dx.op.waveMultiPrefixBitCount(i32 167, i1
  RepackingPoint(44);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 46
  // CHECK: call i64 @dx.op.waveMultiPrefixOp.i64(i32 166, i64
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 47
  // CHECK: call i64 @dx.op.waveMultiPrefixOp.i64(i32 166, i64
  RepackingPoint(46);
  ...
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 48
  // CHECK: call i64 @dx.op.waveMultiPrefixOp.i64(i32 166, i64
  // CHECK: call void @dx.op.callShader.struct.Payload(i32 159, i32 49
  // CHECK: call i64 @dx.op.waveMultiPrefixOp.i64(i32 166, i64
  RepackingPoint(48);
