...
public:
  ...
  HRESULT STDMETHODCALLTYPE
  RegisterIntrinsicTable(_In_ IDxcIntrinsicTable *pTable) {
    try {
      IFTPTR(pTable);
  ...
  HRESULT STDMETHODCALLTYPE
  SetSemanticDefineValidator(_In_ IDxcSemanticDefineValidator *pValidator) {
...
#define DXC_LANGEXTENSIONS_HELPER_IMPL(_helper_field_)                         \
  HRESULT STDMETHODCALLTYPE RegisterIntrinsicTable(                            \
      _In_ IDxcIntrinsicTable *pTable) override {                              \
  ...
  HRESULT STDMETHODCALLTYPE SetSemanticDefineValidator(                        \
      _In_ IDxcSemanticDefineValidator *pValidator) override {                 \
    DxcThreadMalloc TM(m_pMalloc);                                             \
