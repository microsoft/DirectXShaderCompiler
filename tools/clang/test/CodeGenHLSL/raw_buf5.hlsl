...
// CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %buf2_UAV_rawbuf, i32 1, i32 undef, half %{{[a-zA-Z0-9.]+}}, half undef, half undef, half undef, i8 1)
// CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %buf2_UAV_rawbuf, i32 1, i32 undef, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, half undef, half undef, i8 3)
// CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %buf2_UAV_rawbuf, i32 1, i32 undef, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, half undef, i8 7)
// CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %buf2_UAV_rawbuf, i32 1, i32 undef, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, half %{{[a-zA-Z0-9.]+}}, i8 15)
