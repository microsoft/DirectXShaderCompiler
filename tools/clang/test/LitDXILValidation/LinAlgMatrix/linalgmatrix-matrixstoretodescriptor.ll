...
define void @main() {
  ...
  %4 = call %dx.types.LinAlgMatrixC8M4N4U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M4N4U0S1(i32 325, %dx.types.Handle %3, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %5, i32 0, i32 0, i32 4, i32 256)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %6, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %7, i32 0, i32 0, i32 0, i32 298)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %8, i32 0, i32 0, i32 0, i32 0)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %12, i32 0, i32 0, i32 0, i32 %11)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U0S1(i32 331, %dx.types.LinAlgMatrixC8M4N4U0S1 %4, %dx.types.Handle %13, i32 0, i32 0, i32 %11, i32 256)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  %15 = call %dx.types.LinAlgMatrixC8M4N4U2S0 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M4N4U2S0(i32 325, %dx.types.Handle %14, i32 0, i32 0, i32 4, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgMatrixStoreToDescriptor.mC8M4N4U2S0(i32 331, %dx.types.LinAlgMatrixC8M4N4U2S0 %15, %dx.types.Handle %16, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixStoreToDescriptor(matrix,handle,offset,stride,layout,align)
