...
float4 main() : SV_Target {
    // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %g_sb1_UAV_structbuf, i32 0, i32 0, half 0xH3C00, half 0xH3C00, half 0xH3C00, half undef, i8 7, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %g_sb1_UAV_structbuf, i32 0, i32 24, half 0xH4200, half 0xH4200, half 0xH4200, half undef, i8 7, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %g_sb1_UAV_structbuf, i32 0, i32 48, half 0xH4600, half undef, half undef, half undef, i8 1, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %g_sb1_UAV_structbuf, i32 0, i32 52, half 0xH4800, half undef, half undef, half undef, i8 1, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %g_sb1_UAV_structbuf, i32 0, i32 60, i16 10, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.f16(i32 140, %dx.types.Handle %g_sb2_UAV_structbuf, i32 0, i32 8, half 0xH4000, half 0xH4000, half 0xH4000, half undef, i8 7, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %g_sb2_UAV_structbuf, i32 0, i32 20, i16 4, i16 undef, i16 undef, i16 undef, i8 1, i32 4)
    ...
    // CHECK: call void @dx.op.rawBufferStore.i16(i32 140, %dx.types.Handle %g_sb2_UAV_structbuf, i32 0, i32 28, i16 6, i16 6, i16 6, i16 undef, i8 7, i32 4)
