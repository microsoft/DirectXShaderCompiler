...
bool left9; min16int right9; left9 = right9;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
bool left10; min12int right10; left10 = right10;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
bool left11; min16uint right11; left11 = right11; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
int left21; min16int right21; left21 = right21;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
int left22; min12int right22; left22 = right22;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
int left23; min16uint right23; left23 = right23; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
uint left33; min16int right33; left33 = right33;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
uint left34; min12int right34; left34 = right34;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
uint left35; min16uint right35; left35 = right35; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
dword left45; min16int right45; left45 = right45;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
dword left46; min12int right46; left46 = right46;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
dword left47; min16uint right47; left47 = right47; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
half left57; min16int right57; left57 = right57;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
half left58; min12int right58; left58 = right58;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
half left59; min16uint right59; left59 = right59; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
float left69; min16int right69; left69 = right69;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
float left70; min12int right70; left70 = right70;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
float left71; min16uint right71; left71 = right71; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
double left81; min16int right81; left81 = right81;    /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
double left82; min12int right82; left82 = right82;  // expected-warning {{min12int is promoted to min16int}} fxc-pass {{}}
double left83; min16uint right83; left83 = right83; /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
min16float left93; min16int right93; left93 = right93;    /* expected-warning {{min16float is promoted to half}} expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
min16float left94; min12int right94; left94 = right94;  // expected-warning {{min12int is promoted to min16int}} expected-warning {{min16float is promoted to half}} fxc-pass {{}}
min16float left95; min16uint right95; left95 = right95; /* expected-warning {{min16float is promoted to half}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
min16int left108; bool right108; left108 = right108;        /* expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
...
min16int left115; min16float right115; left115 = right115;    /* expected-warning {{min16float is promoted to half}} expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
min16int left116; min10float right116; left116 = right116;  // expected-warning {{min10float is promoted to half}} expected-warning {{min16int is promoted to int}} fxc-pass {{}}
min16int left117; min16int right117; left117 = right117;    /* expected-warning {{min16int is promoted to int}} expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
min16int left118; min12int right118; left118 = right118;  // expected-warning {{min12int is promoted to min16int}} expected-warning {{min16int is promoted to int}} fxc-pass {{}}
min16int left119; min16uint right119; left119 = right119; /* expected-warning {{min16int is promoted to int}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
min12int left128; min10float right128; left128 = right128;  // expected-warning {{min10float is promoted to half}} expected-warning {{min12int is promoted to min16int}} fxc-pass {{}} //
...
min16uint left132; bool right132; left132 = right132;     /* expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
min16uint left139; min16float right139; left139 = right139;    /* expected-warning {{min16float is promoted to half}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
min16uint left140; min10float right140; left140 = right140;  // expected-warning {{min10float is promoted to half}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}}
min16uint left141; min16int right141; left141 = right141;    /* expected-warning {{min16int is promoted to int}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
min16uint left142; min12int right142; left142 = right142;  // expected-warning {{min12int is promoted to min16int}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}}
min16uint left143; min16uint right143; left143 = right143; /* expected-warning {{min16uint is promoted to uint}} expected-warning {{min16uint is promoted to uint}} fxc-pass {{}} */
...
int16_t left154; min12int right154; left154 = right154;    /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'int16_t'}} fxc-error {{X3000: unrecognized identifier 'left154'}} */
...
int32_t left174; min12int right174; left174 = right174;    /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'int32_t'}} fxc-error {{X3000: unrecognized identifier 'left174'}} */
...
int64_t left194; min12int right194; left194 = right194;    /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'int64_t'}} fxc-error {{X3000: unrecognized identifier 'left194'}} */
...
float16_t left214; min12int right214; left214 = right214;  /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'float16_t'}} fxc-error {{X3000: unrecognized identifier 'left214'}} */
...
float32_t left234; min12int right234; left234 = right234;  /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'float32_t'}} fxc-error {{X3000: unrecognized identifier 'left234'}} */
...
float64_t left254; min12int right254; left254 = right254;  /* expected-warning {{min12int is promoted to min16int}} fxc-error {{X3000: unrecognized identifier 'float64_t'}} fxc-error {{X3000: unrecognized identifier 'left254'}} */
