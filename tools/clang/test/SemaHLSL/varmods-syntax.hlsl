// RUN: %dxc -Tlib_6_3 -HV 2021 -Wno-hlsl-groupshared-202x -verify %s
...
groupshared precise static volatile float2 g_gro_pre_sta_vol;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_sta_vol': global variables cannot be declared 'volatile'}} */
groupshared precise static volatile const float2 g_gro_pre_sta_vol_con;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_sta_vol_con': global variables cannot be declared 'volatile'}} */
...
groupshared precise uniform volatile float2 g_gro_pre_uni_vol;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_uni_vol': global variables cannot be declared 'volatile'}} fxc-error {{X3010: 'g_gro_pre_uni_vol': uniform global variables cannot be declared 'groupshared'}} */
...
groupshared precise volatile float2 g_gro_pre_vol;          /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_vol': global variables cannot be declared 'volatile'}} */
groupshared precise volatile const float2 g_gro_pre_vol_con;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_vol_con': global variables cannot be declared 'volatile'}} */
...
groupshared static volatile float2 g_gro_sta_vol;           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_sta_vol': global variables cannot be declared 'volatile'}} */
groupshared static volatile const float2 g_gro_sta_vol_con; /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_sta_vol_con': global variables cannot be declared 'volatile'}} */
...
groupshared uniform volatile float2 g_gro_uni_vol;          /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_uni_vol': global variables cannot be declared 'volatile'}} fxc-error {{X3010: 'g_gro_uni_vol': uniform global variables cannot be declared 'groupshared'}} */
groupshared uniform volatile const float2 g_gro_uni_vol_con;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_uni_vol_con': global variables cannot be declared 'volatile'}} fxc-error {{X3010: 'g_gro_uni_vol_con': uniform global variables cannot be declared 'groupshared'}} */
...
groupshared volatile float2 g_gro_vol;                      /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_vol': global variables cannot be declared 'volatile'}} */
groupshared volatile const float2 g_gro_vol_con;            /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_vol_con': global variables cannot be declared 'volatile'}} */
...
extern precise uniform volatile float2 g_ext_pre_uni_vol;   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_uni_vol': global variables cannot be declared 'volatile'}} */
extern precise uniform volatile const float2 g_ext_pre_uni_vol_con;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_uni_vol_con': global variables cannot be declared 'volatile'}} */
extern precise uniform const float2 g_ext_pre_uni_con;
extern precise volatile float2 g_ext_pre_vol;               /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_vol': global variables cannot be declared 'volatile'}} */
extern precise volatile const float2 g_ext_pre_vol_con;     /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_vol_con': global variables cannot be declared 'volatile'}} */
extern precise const float2 g_ext_pre_con;
extern uniform float2 g_ext_uni;
extern uniform volatile float2 g_ext_uni_vol;               /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_uni_vol': global variables cannot be declared 'volatile'}} */
extern uniform volatile const float2 g_ext_uni_vol_con;     /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_uni_vol_con': global variables cannot be declared 'volatile'}} */
extern uniform const float2 g_ext_uni_con;
extern volatile float2 g_ext_vol;                           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_vol': global variables cannot be declared 'volatile'}} */
extern volatile const float2 g_ext_vol_con;                 /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_vol_con': global variables cannot be declared 'volatile'}} */
extern const float2 g_ext_con;
precise float2 g_pre;
precise static float2 g_pre_sta;
precise static volatile float2 g_pre_sta_vol;               /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_sta_vol': global variables cannot be declared 'volatile'}} */
precise static volatile const float2 g_pre_sta_vol_con;     /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_sta_vol_con': global variables cannot be declared 'volatile'}} */
precise static const float2 g_pre_sta_con;
precise uniform float2 g_pre_uni;
precise uniform volatile float2 g_pre_uni_vol;              /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_uni_vol': global variables cannot be declared 'volatile'}} */
precise uniform volatile const float2 g_pre_uni_vol_con;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_uni_vol_con': global variables cannot be declared 'volatile'}} */
precise uniform const float2 g_pre_uni_con;
precise volatile float2 g_pre_vol;                          /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_vol': global variables cannot be declared 'volatile'}} */
precise volatile const float2 g_pre_vol_con;                /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_vol_con': global variables cannot be declared 'volatile'}} */
precise const float2 g_pre_con;
static float2 g_sta;
static volatile float2 g_sta_vol;                           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_sta_vol': global variables cannot be declared 'volatile'}} */
static volatile const float2 g_sta_vol_con;                 /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_sta_vol_con': global variables cannot be declared 'volatile'}} */
static const float2 g_sta_con;
uniform float2 g_uni;
uniform volatile float2 g_uni_vol;                          /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_uni_vol': global variables cannot be declared 'volatile'}} */
uniform volatile const float2 g_uni_vol_con;                /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_uni_vol_con': global variables cannot be declared 'volatile'}} */
uniform const float2 g_uni_con;
volatile float2 g_vol;                                      /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_vol': global variables cannot be declared 'volatile'}} */
volatile const float2 g_vol_con;                            /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_vol_con': global variables cannot be declared 'volatile'}} */
const float2 g_con;
// GENERATED_CODE:END
...
groupshared precise static volatile float g_gro_pre_sta_vol_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_sta_vol_init': global variables cannot be declared 'volatile'}} */
groupshared precise static volatile const float g_gro_pre_sta_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_sta_vol_con_init': global variables cannot be declared 'volatile'}} */
...
groupshared precise volatile float g_gro_pre_vol_init = 1.0f;             /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_vol_init': global variables cannot be declared 'volatile'}} */
groupshared precise volatile const float g_gro_pre_vol_con_init = 1.0f;   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_pre_vol_con_init': global variables cannot be declared 'volatile'}} */
groupshared precise const float g_gro_pre_con_init = 1.0f;
groupshared static float g_gro_sta_init = 1.0f;
groupshared static volatile float g_gro_sta_vol_init = 1.0f;              /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_sta_vol_init': global variables cannot be declared 'volatile'}} */
groupshared static volatile const float g_gro_sta_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_sta_vol_con_init': global variables cannot be declared 'volatile'}} */
...
groupshared uniform volatile float g_gro_uni_vol_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_uni_vol_init': global variables cannot be declared 'volatile'}} fxc-error {{X3010: 'g_gro_uni_vol_init': uniform global variables cannot be declared 'groupshared'}} */
...
groupshared volatile float g_gro_vol_init = 1.0f;           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_vol_init': global variables cannot be declared 'volatile'}} */
groupshared volatile const float g_gro_vol_con_init = 1.0f; /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_gro_vol_con_init': global variables cannot be declared 'volatile'}} */
...
extern precise uniform volatile float g_ext_pre_uni_vol_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_uni_vol_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
extern precise uniform volatile const float g_ext_pre_uni_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_uni_vol_con_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
...
extern precise volatile float g_ext_pre_vol_init = 1.0f;             /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_vol_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
extern precise volatile const float g_ext_pre_vol_con_init = 1.0f;   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_pre_vol_con_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
...
extern uniform volatile float g_ext_uni_vol_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_uni_vol_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
extern uniform volatile const float g_ext_uni_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_uni_vol_con_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
...
extern volatile float g_ext_vol_init = 1.0f;                /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_vol_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
extern volatile const float g_ext_vol_con_init = 1.0f;      /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_ext_vol_con_init': global variables cannot be declared 'volatile'}} expected-warning {{'extern' variable has an initializer}} */
...
precise static volatile float g_pre_sta_vol_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_sta_vol_init': global variables cannot be declared 'volatile'}} */
precise static volatile const float g_pre_sta_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_sta_vol_con_init': global variables cannot be declared 'volatile'}} */
precise static const float g_pre_sta_con_init = 1.0f;
precise uniform float g_pre_uni_init = 1.0f;
precise uniform volatile float g_pre_uni_vol_init = 1.0f;   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_uni_vol_init': global variables cannot be declared 'volatile'}} */
precise uniform volatile const float g_pre_uni_vol_con_init = 1.0f;    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_uni_vol_con_init': global variables cannot be declared 'volatile'}} */
...
precise volatile float g_pre_vol_init = 1.0f;               /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_vol_init': global variables cannot be declared 'volatile'}} */
precise volatile const float g_pre_vol_con_init = 1.0f;     /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_pre_vol_con_init': global variables cannot be declared 'volatile'}} */
...
static volatile float g_sta_vol_init = 1.0f;                /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_sta_vol_init': global variables cannot be declared 'volatile'}} */
static volatile const float g_sta_vol_con_init = 1.0f;      /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_sta_vol_con_init': global variables cannot be declared 'volatile'}} */
static const float g_sta_con_init = 1.0f;
uniform float g_uni_init = 1.0f;
uniform volatile float g_uni_vol_init = 1.0f;               /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_uni_vol_init': global variables cannot be declared 'volatile'}} */
uniform volatile const float g_uni_vol_con_init = 1.0f;     /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_uni_vol_con_init': global variables cannot be declared 'volatile'}} */
...
volatile float g_vol_init = 1.0f;                           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_vol_init': global variables cannot be declared 'volatile'}} */
volatile const float g_vol_con_init = 1.0f;                 /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'g_vol_con_init': global variables cannot be declared 'volatile'}} */
...
in out float g_in;                                          /* expected-error {{HLSL usage 'in' is only valid on a parameter}} expected-error {{HLSL usage 'out' is only valid on a parameter}} fxc-error {{X3000: syntax error: unexpected token 'in'}} */
...
typedef groupshared precise volatile float2 t_gro_pre_vol;             /* expected-error {{'groupshared' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef groupshared precise volatile const float2 t_gro_pre_vol_con;   /* expected-error {{'groupshared' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef groupshared uniform volatile float2 t_gro_uni_vol;  /* expected-error {{'groupshared' is not a valid modifier for a typedef}} expected-error {{'uniform' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef groupshared volatile float2 t_gro_vol;              /* expected-error {{'groupshared' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef groupshared volatile const float2 t_gro_vol_con;    /* expected-error {{'groupshared' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef extern precise uniform volatile float2 t_ext_pre_uni_vol;    /* expected-error {{'uniform' is not a valid modifier for a typedef}} expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef extern precise volatile float2 t_ext_pre_vol;             /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef extern precise volatile const float2 t_ext_pre_vol_con;   /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef extern uniform volatile float2 t_ext_uni_vol;       /* expected-error {{'uniform' is not a valid modifier for a typedef}} expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef extern volatile float2 t_ext_vol;                   /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef extern volatile const float2 t_ext_vol_con;         /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef precise static volatile float2 t_pre_sta_vol;       /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'static'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef precise static volatile const float2 t_pre_sta_vol_con;    /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'static'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef precise uniform volatile float2 t_pre_uni_vol;      /* expected-error {{'uniform' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef precise uniform volatile const float2 t_pre_uni_vol_con;    /* expected-error {{'uniform' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef static volatile float2 t_sta_vol;                   /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'static'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef static volatile const float2 t_sta_vol_con;         /* expected-error {{cannot combine with previous 'typedef' declaration specifier}} fxc-error {{X3000: syntax error: unexpected token 'static'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
typedef uniform volatile float2 t_uni_vol;                  /* expected-error {{'uniform' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
typedef uniform volatile const float2 t_uni_vol_con;        /* expected-error {{'uniform' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
struct s_storage_mods {
    ...
    extern volatile float2 f_ext_vol;                       /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{storage class specified for a member declaration}} fxc-error {{X3006: 'f_ext_vol': struct/class members cannot be declared 'extern'}} fxc-error {{X3008: 'f_ext_vol': struct/class members cannot be declared 'volatile'}} */
    ...
    precise static volatile float2 f_pre_sta_vol;           /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_pre_sta_vol': struct/class members cannot be declared 'volatile'}} */
    precise static volatile const float2 f_pre_sta_vol_con; /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_pre_sta_vol_con': struct/class members cannot be declared 'volatile'}} */
    precise static const float2 f_pre_sta_con;              /* fxc-error {{X3103: 's_storage_mods::f_pre_sta_con': variable declared but not defined}} */
    precise uniform float2 f_pre_uni;                       /* expected-error {{'uniform' is not a valid modifier for a field}} expected-warning {{'uniform' attribute only applies to variables and parameters}} fxc-error {{X3047: 'f_pre_uni': struct/class members cannot be declared 'uniform'}} */
    ...
    precise volatile float2 f_pre_vol;                      /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_pre_vol': struct/class members cannot be declared 'volatile'}} */
    ...
    static volatile float2 f_sta_vol;                       /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_sta_vol': struct/class members cannot be declared 'volatile'}} */
    static volatile const float2 f_sta_vol_con;             /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_sta_vol_con': struct/class members cannot be declared 'volatile'}} */
    static const float2 f_sta_con;                          /* fxc-error {{X3103: 's_storage_mods::f_sta_con': variable declared but not defined}} */
    uniform float2 f_uni;                                   /* expected-error {{'uniform' is not a valid modifier for a field}} expected-warning {{'uniform' attribute only applies to variables and parameters}} fxc-error {{X3047: 'f_uni': struct/class members cannot be declared 'uniform'}} */
    ...
    uniform const float2 f_uni_con;                         /* expected-error {{'const' is not a valid modifier for a field}} expected-error {{'uniform' is not a valid modifier for a field}} expected-warning {{'uniform' attribute only applies to variables and parameters}} fxc-error {{X3035: 'f_uni_con': struct/class members cannot be declared 'const'}} fxc-error {{X3047: 'f_uni_con': struct/class members cannot be declared 'uniform'}} */
    volatile float2 f_vol;                                  /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_vol': struct/class members cannot be declared 'volatile'}} */
    volatile const float2 f_vol_con;                        /* expected-error {{'const' is not a valid modifier for a field}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3008: 'f_vol_con': struct/class members cannot be declared 'volatile'}} fxc-error {{X3035: 'f_vol_con': struct/class members cannot be declared 'const'}} */
...
struct s_inout {
    in float2 f_in;                                         /* expected-error {{HLSL usage 'in' is only valid on a parameter}} expected-warning {{'in' attribute only applies to parameters}} fxc-error {{X3000: syntax error: unexpected token 'in'}} */
    out float2 f_out;                                       /* expected-error {{HLSL usage 'out' is only valid on a parameter}} expected-warning {{'out' attribute only applies to parameters}} fxc-error {{X3000: syntax error: unexpected token 'out'}} */
    inout float2 f_inout;                                   /* expected-error {{HLSL usage 'inout' is only valid on a parameter}} expected-warning {{'inout' attribute only applies to parameters}} fxc-error {{X3000: syntax error: unexpected token 'inout'}} */
};
...
// GENERATED_CODE:BEGIN
float4 foo_gro_ext(groupshared extern float4 val) { return val; }    /* expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_ext': function must return a value}} */
...
float4 foo_gro(groupshared float4 val) { return val; }      /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro': function must return a value}} */
float4 foo_gro_pre(groupshared precise float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre': function must return a value}} */
...
float4 foo_gro_pre_sta_vol(groupshared precise static volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_sta_vol': function must return a value}} */
float4 foo_gro_pre_sta_vol_con(groupshared precise static volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_sta_vol_con': function must return a value}} */
float4 foo_gro_pre_sta_con(groupshared precise static const float4 val) { return val; }    /* expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_sta_con': function must return a value}} */
float4 foo_gro_pre_uni(groupshared precise uniform float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_uni': function must return a value}} */
...
float4 foo_gro_pre_uni_con(groupshared precise uniform const float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_uni_con': function must return a value}} */
float4 foo_gro_pre_vol(groupshared precise volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_vol': function must return a value}} */
float4 foo_gro_pre_vol_con(groupshared precise volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_vol_con': function must return a value}} */
float4 foo_gro_pre_con(groupshared precise const float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_pre_con': function must return a value}} */
float4 foo_gro_sta(groupshared static float4 val) { return val; }    /* expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_sta': function must return a value}} */
float4 foo_gro_sta_vol(groupshared static volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_sta_vol': function must return a value}} */
...
float4 foo_gro_sta_con(groupshared static const float4 val) { return val; }    /* expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_sta_con': function must return a value}} */
float4 foo_gro_uni(groupshared uniform float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_uni': function must return a value}} */
float4 foo_gro_uni_vol(groupshared uniform volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_uni_vol': function must return a value}} */
float4 foo_gro_uni_vol_con(groupshared uniform volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_uni_vol_con': function must return a value}} */
float4 foo_gro_uni_con(groupshared uniform const float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_uni_con': function must return a value}} */
float4 foo_gro_vol(groupshared volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_vol': function must return a value}} */
float4 foo_gro_vol_con(groupshared volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_vol_con': function must return a value}} */
float4 foo_gro_con(groupshared const float4 val) { return val; }    /* fxc-error {{X3000: syntax error: unexpected token 'groupshared'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_gro_con': function must return a value}} */
...
float4 foo_ext_pre_vol_con(extern precise volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_ext_pre_vol_con': function must return a value}} */
...
float4 foo_ext_vol(extern volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_ext_vol': function must return a value}} */
float4 foo_ext_vol_con(extern volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'extern'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_ext_vol_con': function must return a value}} */
...
float4 foo_pre_sta_vol(precise static volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'static'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_pre_sta_vol': function must return a value}} */
float4 foo_pre_sta_vol_con(precise static volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'static'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_pre_sta_vol_con': function must return a value}} */
...
float4 foo_pre_uni_vol(precise uniform volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_pre_uni_vol_con(precise uniform volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_pre_uni_con(precise uniform const float4 val) { return val; }
float4 foo_pre_vol(precise volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_pre_vol_con(precise volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
float4 foo_sta_vol(static volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'static'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_sta_vol': function must return a value}} */
float4 foo_sta_vol_con(static volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{invalid storage class specifier in function declarator}} fxc-error {{X3000: syntax error: unexpected token 'static'}} fxc-error {{X3004: undeclared identifier 'val'}} fxc-error {{X3080: 'foo_sta_vol_con': function must return a value}} */
...
float4 foo_uni_vol(uniform volatile float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_uni_vol_con(uniform volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_uni_con(uniform const float4 val) { return val; }
float4 foo_vol(volatile float4 val) { return val; }         /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
float4 foo_vol_con(volatile const float4 val) { return val; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
//////////////////////////////////////////////////////////////////////////////
// Use gs topology input modifiers
struct FooStruct { float4 bar : BAR; };
void foo_point(point FooStruct In[1]);
void foo_line(line FooStruct In[2]);
void foo_lineadj(lineadj FooStruct In[4]);
void foo_triangle(triangle FooStruct In[3]);
void foo_triangleadj(triangleadj FooStruct In[6]);
/*verify-ast
  FunctionDecl <col:1, col:49> col:6 foo_triangleadj 'void (FooStruct [6])'
  `-ParmVarDecl <col:22, col:48> col:44 In 'FooStruct [6]'
    `-HLSLTriangleAdjAttr <col:22>
*/

// Invalid cases:
int point;                                                  /* expected-error {{modifiers must appear before type}} expected-warning {{declaration does not declare anything}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
void foo_point2(FooStruct point In[1]);                     /* expected-error {{modifiers must appear before type}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
void foo_triangle_point(triangle point FooStruct In);       /* expected-error {{'triangle' and 'point' cannot be used together for a parameter}} fxc-error {{X3083: conflicting geometry types}} */
void foo_uniform_point(uniform point FooStruct In);         /* expected-error {{'point' and 'uniform' cannot be used together for a parameter}} fxc-pass {{}} */
void foo_sample_point(sample point FooStruct In);           /* expected-error {{'point' and 'sample' cannot be used together for a parameter}} fxc-pass {{}} */
void foo_nointerpolation_point(nointerpolation point FooStruct In);    /* expected-error {{'point' and 'nointerpolation' cannot be used together for a parameter}} fxc-pass {{}} */
point float4 foo_point_ret(FooStruct In);                   /* expected-error {{'point' is not a valid modifier for a function}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
point float4 g_point;                                       /* expected-error {{'point' is not a valid modifier for a global variable}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
float4 point g_point2;                                      /* expected-error {{modifiers must appear before type}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
float4 g_point3 point;                                      /* expected-error {{expected ';' after top level declarator}} expected-warning {{declaration does not declare anything}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
typedef point FooStruct FooStructPoint;                     /* expected-error {{'point' is not a valid modifier for a typedef}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
point struct PointStruct1 {                                 /* expected-warning {{attribute 'point' is ignored, place it after "struct" to apply attribute to type declaration}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 bar;
};
struct point PointStruct2 {                                 /* expected-error {{declaration of anonymous struct must be a definition}} expected-warning {{declaration does not declare anything}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 bar;
};
struct PointStruct3 point {                                 /* expected-error {{expected unqualified-id}} expected-error {{modifiers must appear before type}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 bar;
};
struct PointField {
    point float4 bar;                                       /* expected-error {{'point' is not a valid modifier for a field}} expected-note {{previous declaration is here}} expected-note {{previous declaration is here}} expected-warning {{'point' attribute only applies to parameters}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 point bar;                                       /* expected-error {{duplicate member 'bar'}} expected-error {{modifiers must appear before type}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 bar point;                                       /* expected-error {{duplicate member 'bar'}} expected-error {{expected ';' at end of declaration list}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
};
void local_topology() {
    point float4 bar1;                                      /* expected-error {{'point' is not a valid modifier for a local variable}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 point bar2;                                      /* expected-error {{modifiers must appear before type}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
    float4 bar3 point;                                      /* expected-error {{expected ';' at end of declaration}} expected-warning {{declaration does not declare anything}} fxc-error {{X3000: syntax error: unexpected token 'point'}} */
}
class CTopology
{
    // Members
...
void vain() {
    ...
    groupshared precise static volatile float l_gro_pre_sta_vol;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_sta_vol': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    groupshared precise static volatile const float l_gro_pre_sta_vol_con;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_sta_vol_con': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared precise volatile float l_gro_pre_vol;             /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_vol': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    groupshared precise volatile const float l_gro_pre_vol_con;   /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_vol_con': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared static volatile float l_gro_sta_vol;        /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_sta_vol': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    groupshared static volatile const float l_gro_sta_vol_con;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_sta_vol_con': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared volatile float l_gro_vol;                   /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_vol': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    groupshared volatile const float l_gro_vol_con;         /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_vol_con': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    extern precise volatile float l_ext_pre_vol;            /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_pre_vol': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    extern precise volatile const float l_ext_pre_vol_con;  /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_pre_vol_con': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    extern volatile float l_ext_vol;                        /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_vol': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    extern volatile const float l_ext_vol_con;              /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_vol_con': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    precise uniform volatile float l_pre_uni_vol;           /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_pre_uni_vol': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    precise uniform volatile const float l_pre_uni_vol_con; /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_pre_uni_vol_con': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    uniform volatile float l_uni_vol;                       /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_uni_vol': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    uniform volatile const float l_uni_vol_con;             /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_uni_vol_con': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    // GENERATED_CODE:BEGIN
    groupshared precise static volatile const float l_gro_pre_sta_vol_con_init = 0.0;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_sta_vol_con_init': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared precise uniform volatile const float l_gro_pre_uni_vol_con_init = 0.0;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_uni_vol_con_init': local variables cannot be declared 'groupshared'}} fxc-error {{X3047: 'l_gro_pre_uni_vol_con_init': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared precise volatile const float l_gro_pre_vol_con_init = 0.0;   /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_pre_vol_con_init': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared static volatile const float l_gro_sta_vol_con_init = 0.0;    /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_sta_vol_con_init': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    groupshared volatile const float l_gro_vol_con_init = 0.0;   /* expected-error {{'groupshared' is not a valid modifier for a local variable}} fxc-error {{X3010: 'l_gro_vol_con_init': local variables cannot be declared 'groupshared'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    extern precise volatile const float l_ext_pre_vol_con_init = 0.0;   /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_pre_vol_con_init': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    extern volatile const float l_ext_vol_con_init = 0.0;   /* expected-error {{'extern' is not a valid modifier for a local variable}} fxc-error {{X3006: 'l_ext_vol_con_init': local variables cannot be declared 'extern'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    precise uniform volatile const float l_pre_uni_vol_con_init = 0.0;    /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_pre_uni_vol_con_init': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
    ...
    uniform volatile const float l_uni_vol_con_init = 0.0;  /* expected-error {{'uniform' is not a valid modifier for a local variable}} fxc-error {{X3047: 'l_uni_vol_con_init': local variables cannot be declared 'uniform'}} expected-error {{'volatile' is a reserved keyword in HLSL}} */
...
groupshared precise static volatile float fn_gro_pre_sta_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
groupshared precise static volatile const float fn_gro_pre_sta_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
...
groupshared precise volatile float fn_gro_pre_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
groupshared precise volatile const float fn_gro_pre_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
...
groupshared static volatile float fn_gro_sta_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
groupshared static volatile const float fn_gro_sta_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
groupshared volatile float fn_gro_vol() { return 1.0f; }        /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
groupshared volatile const float fn_gro_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
extern precise volatile float fn_ext_pre_vol() { return 1.0f; } /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3006: 'fn_ext_pre_vol': functions cannot be declared 'extern'}} expected-error {{'extern' is not a valid modifier for a function}} */
extern precise volatile const float fn_ext_pre_vol_con() { return 1.0f; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3006: 'fn_ext_pre_vol_con': functions cannot be declared 'extern'}} expected-error {{'extern' is not a valid modifier for a function}} */
...
extern volatile float fn_ext_vol() { return 1.0f; }             /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3006: 'fn_ext_vol': functions cannot be declared 'extern'}} expected-error {{'extern' is not a valid modifier for a function}} */
extern volatile const float fn_ext_vol_con() { return 1.0f; }   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3006: 'fn_ext_vol_con': functions cannot be declared 'extern'}} expected-error {{'extern' is not a valid modifier for a function}} */
...
precise static volatile float fn_pre_sta_vol() { return 1.0f; } /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
precise static volatile const float fn_pre_sta_vol_con() { return 1.0f; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
...
precise uniform volatile float fn_pre_uni_vol() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_pre_uni_vol': functions cannot be declared 'uniform'}} */
precise uniform volatile const float fn_pre_uni_vol_con() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_pre_uni_vol_con': functions cannot be declared 'uniform'}} */
...
precise volatile float fn_pre_vol() { return 1.0f; }            /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
precise volatile const float fn_pre_vol_con() { return 1.0f; }  /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
precise const float fn_pre_con() { return 1.0f; }               /* fxc-error {{X3025: l-value specifies const object}} */
static float fn_sta() { return 1.0f; }
static volatile float fn_sta_vol() { return 1.0f; }             /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
static volatile const float fn_sta_vol_con() { return 1.0f; }   /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
uniform volatile float fn_uni_vol() { return 1.0f; }            /* expected-error {{'uniform' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_uni_vol': functions cannot be declared 'uniform'}} */
uniform volatile const float fn_uni_vol_con() { return 1.0f; }  /* expected-error {{'uniform' is not a valid modifier for a function}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_uni_vol_con': functions cannot be declared 'uniform'}} */
...
volatile float fn_vol() { return 1.0f; }                        /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
volatile const float fn_vol_con() { return 1.0f; }              /* expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
...
class C
{
    ...
    groupshared precise static volatile float fn_gro_pre_sta_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    groupshared precise static volatile const float fn_gro_pre_sta_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
    ...
    groupshared precise volatile float fn_gro_pre_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    groupshared precise volatile const float fn_gro_pre_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3025: l-value specifies const object}} */
    ...
    groupshared static volatile float fn_gro_sta_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    groupshared static volatile const float fn_gro_sta_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    ...
    groupshared volatile float fn_gro_vol() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    groupshared volatile const float fn_gro_vol_con() { return 1.0f; }    /* expected-error {{'groupshared' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-pass {{}} */
    ...
    extern precise volatile float fn_ext_pre_vol() { return 1.0f; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{storage class specified for a member declaration}} fxc-error {{X3006: 'fn_ext_pre_vol': functions cannot be declared 'extern'}} */
    extern precise volatile const float fn_ext_pre_vol_con() { return 1.0f; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{storage class specified for a member declaration}} fxc-error {{X3006: 'fn_ext_pre_vol_con': functions cannot be declared 'extern'}} */
    ...
    extern volatile float fn_ext_vol() { return 1.0f; }     /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{storage class specified for a member declaration}} fxc-error {{X3006: 'fn_ext_vol': functions cannot be declared 'extern'}} */
    extern volatile const float fn_ext_vol_con() { return 1.0f; }    /* expected-error {{'volatile' is a reserved keyword in HLSL}} expected-error {{storage class specified for a member declaration}} fxc-error {{X3006: 'fn_ext_vol_con': functions cannot be declared 'extern'}} */
    ...
    precise uniform volatile float fn_pre_uni_vol() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_pre_uni_vol': functions cannot be declared 'uniform'}} */
    precise uniform volatile const float fn_pre_uni_vol_con() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_pre_uni_vol_con': functions cannot be declared 'uniform'}} */
    ...
    uniform volatile float fn_uni_vol() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_uni_vol': functions cannot be declared 'uniform'}} */
    uniform volatile const float fn_uni_vol_con() { return 1.0f; }    /* expected-error {{'uniform' is not a valid modifier for a method}} expected-error {{'volatile' is a reserved keyword in HLSL}} fxc-error {{X3047: 'fn_uni_vol_con': functions cannot be declared 'uniform'}} */
