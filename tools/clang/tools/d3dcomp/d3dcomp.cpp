...
HRESULT WINAPI BridgeD3DDisassemble(_In_reads_bytes_(SrcDataSize)
                                        LPCVOID pSrcData,
...
HRESULT WINAPI BridgeD3DReflect(_In_reads_bytes_(SrcDataSize) LPCVOID pSrcData,
...
HRESULT WINAPI BridgeReadFileToBlob(_In_ LPCWSTR pFileName,
...
HRESULT WINAPI BridgeD3DPreprocess(
    _In_reads_bytes_(SrcDataSize) LPCVOID pSrcData, _In_ SIZE_T SrcDataSize,
    _In_opt_ LPCSTR pSourceName, _In_opt_ const D3D_SHADER_MACRO *pDefines,
    _In_opt_ ID3DInclude *pInclude, _Out_ ID3DBlob **ppCodeText,
