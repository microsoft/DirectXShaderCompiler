...
_Success_(return != false) bool WideToEncodedString(_In_z_ const wchar_t *text,
                                                    size_t cWide, DWORD cp,
                                                    DWORD flags,
...
_Use_decl_annotations_ bool UTF8ToWideString(const char *pUTF8,
                                             std::wstring *pWide) {
  size_t cbUTF8 = (pUTF8 == nullptr) ? 0 : strlen(pUTF8);
  return UTF8ToWideString(pUTF8, cbUTF8, pWide);
}

_Use_decl_annotations_ bool UTF8ToWideString(const char *pUTF8, size_t cbUTF8,
                                             std::wstring *pWide) {
...
_Use_decl_annotations_ bool UTF8ToConsoleString(_In_z_ const char *text,
                                                _In_ size_t textLen,
                                                _Inout_ std::string *pValue,
                                                _Out_opt_ bool *lossy) {
...
_Use_decl_annotations_ bool WideToConsoleString(const wchar_t *text,
                                                _In_ size_t textLen,
                                                std::string *pValue,
                                                bool *lossy) {
  DXASSERT_NOMSG(text != nullptr);
...
WideToConsoleString(const wchar_t *text, std::string *pValue, bool *lossy) {
  return WideToConsoleString(text, wcslen(text), pValue, lossy);
}

_Use_decl_annotations_ bool WideToUTF8String(const wchar_t *pWide, size_t cWide,
                                             std::string *pUTF8) {
  DXASSERT_NOMSG(pWide != nullptr);
...
_Use_decl_annotations_ bool WideToUTF8String(const wchar_t *pWide,
                                             std::string *pUTF8) {
  DXASSERT_NOMSG(pWide != nullptr);
  DXASSERT_NOMSG(pUTF8 != nullptr);
...
_Use_decl_annotations_ bool UTF8BufferToWideComHeap(const char *pUTF8,
                                                    wchar_t **ppWide) throw() {
  *ppWide = nullptr;
...
_Use_decl_annotations_ bool UTF8BufferToWideBuffer(const char *pUTF8,
                                                   int cbUTF8, wchar_t **ppWide,
                                                   size_t *pcWide) throw() {
  *ppWide = nullptr;
  *pcWide = 0;
...
_Use_decl_annotations_ bool WideBufferToUTF8Buffer(const wchar_t *pWide,
                                                   int cWide, char **ppUTF8,
                                                   size_t *pcUTF8) throw() {
  *ppUTF8 = nullptr;
  *pcUTF8 = 0;
...
_Use_decl_annotations_ bool IsStarMatchUTF8(const char *pMask, size_t maskLen,
                                            const char *pName, size_t nameLen) {
  return IsStarMatchT<char>(pMask, maskLen, pName, nameLen, '*');
}

_Use_decl_annotations_ bool IsStarMatchWide(const wchar_t *pMask,
                                            size_t maskLen,
                                            const wchar_t *pName,
                                            size_t nameLen) {
