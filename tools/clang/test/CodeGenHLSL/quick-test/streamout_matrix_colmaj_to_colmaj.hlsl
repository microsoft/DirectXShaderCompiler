...
// CHECK: call float @dx.op.loadInput.f32(i32 4, i32 0, i32 2, i8 0, i32 0)
// CHECK: call float @dx.op.loadInput.f32(i32 4, i32 0, i32 2, i8 1, i32 0)
...
// CHECK: call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 2, i8 0, float {{.*}})
// CHECK: call void @dx.op.storeOutput.f32(i32 5, i32 0, i32 2, i8 1, float {{.*}})

struct GSIn { column_major float2x3 value : TEXCOORD0; };
struct GSOut { column_major float2x3 value : TEXCOORD0; };
