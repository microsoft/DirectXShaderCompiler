...
public:
  CustomResourceLowering(StringRef LoweringInfo, CallInst *CI,
...
public:
  static Function *
  GetLoweredFunction(const CustomResourceLowering &CustomLowering,
...
private:
  CustomResourceFunctionTranslator(
      ...
      ResourceFunctionTypeTranslator &typeTranslator, ExtensionLowering &lower)
...
public:
  CustomResourceMethodCall(CallInst *CI,
                           const CustomResourceLowering &CustomLowering)
...
Value *ExtensionLowering::CustomResource(CallInst *CI) {
  CustomResourceLowering CustomLowering(m_extraStrategyInfo, CI,
                                        m_hlResourceLookup);
  ResourceFunctionTypeTranslator ResourceTypeTranslator(m_hlslOp);
  Function *ResourceFunction =
      CustomResourceFunctionTranslator::GetLoweredFunction(
