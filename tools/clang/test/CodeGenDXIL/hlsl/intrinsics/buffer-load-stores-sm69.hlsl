...
void main(uint ix[3] : IX) {
  ...
  RwByBuf.Store< vector<TYPE, NUM>  >(ix[0], babElt1 + babElt2 + babElt3 + babElt4 + status1 + status2);
  ...
  RwStBuf[ix[0]] = stbElt1 + stbElt2 + stbElt3 + stbElt4 + stbElt5 + stbElt6 + status1 + status2;
