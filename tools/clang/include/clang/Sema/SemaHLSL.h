...
/// handled.</param>
void HandleDeclAttributeForHLSL(clang::Sema &S, _In_ clang::Decl *D,
                                const clang::AttributeList &Attr,
                                bool &Handled);

void InitializeInitSequenceForHLSL(
    clang::Sema *sema, const clang::InitializedEntity &Entity,
    const clang::InitializationKind &Kind, clang::MultiExprArg Args,
    bool TopLevelOfInitList,
    _Inout_ clang::InitializationSequence *initSequence);

unsigned
CaculateInitListArraySizeForHLSL(_In_ clang::Sema *sema,
                                 _In_ const clang::InitListExpr *InitList,
                                 _In_ const clang::QualType EltTy);

bool IsConversionToLessOrEqualElements(_In_ clang::Sema *self,
...
clang::ExprResult MaybeConvertMemberAccess(_In_ clang::Sema *Self,
                                           _In_ clang::Expr *E);
...
clang::ExprResult
PerformHLSLConversion(_In_ clang::Sema *self, _In_ clang::Expr *E,
...
clang::Attr *ProcessStmtAttributeForHLSL(clang::Sema &S, _In_ clang::Stmt *St,
                                         const clang::AttributeList &A,
                                         clang::SourceRange Range,
                                         bool &Handled);

bool TryStaticCastForHLSL(
    _In_ clang::Sema *Self, clang::ExprResult &SrcExpr,
    clang::QualType DestType, clang::Sema::CheckedConversionKind CCK,
    const clang::SourceRange &OpRange, unsigned &msg, clang::CastKind &Kind,
    clang::CXXCastPath &BasePath, bool ListInitialization,
    bool SuppressDiagnostics,
    _Inout_opt_ clang::StandardConversionSequence *standard);

clang::ImplicitConversionSequence
TrySubscriptIndexInitialization(_In_ clang::Sema *Self,
...
bool IsMatrixType(_In_ clang::Sema *self, _In_ clang::QualType type);
bool IsVectorType(_In_ clang::Sema *self, _In_ clang::QualType type);
clang::QualType GetOriginalMatrixOrVectorElementType(_In_ clang::QualType type);
clang::QualType GetOriginalElementType(_In_ clang::Sema *self,
                                       _In_ clang::QualType type);

bool IsObjectType(_In_ clang::Sema *self, _In_ clang::QualType type,
                  _Inout_opt_ bool *isDeprecatedEffectObject = nullptr);

bool CanConvert(_In_ clang::Sema *self, clang::SourceLocation loc,
                _In_ clang::Expr *sourceExpr, clang::QualType target,
                bool explicitConversion,
                _Inout_opt_ clang::StandardConversionSequence *standard);
...
void RegisterIntrinsicTable(_In_ clang::ExternalSemaSource *self,
                            IDxcIntrinsicTable *table);

clang::QualType CheckVectorConditional(_In_ clang::Sema *self,
...
// the new type
clang::QualType ApplyTypeSpecSignToParsedType(_In_ clang::Sema *self,
                                              _In_ clang::QualType &type,
