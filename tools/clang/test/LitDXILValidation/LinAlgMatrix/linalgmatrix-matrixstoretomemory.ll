...
define void @main() {
  ...
  %3 = call %dx.types.LinAlgMatrixC9M4N4U0S0 @dx.op.linAlgMatrixLoadFromDescriptor.mC9M4N4U0S0(i32 325, %dx.types.Handle %2, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %5 = call %dx.types.LinAlgMatrixC9M4N4U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC9M4N4U0S1(i32 325, %dx.types.Handle %4, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %7 = call %dx.types.LinAlgMatrixC6M4N4U0S2 @dx.op.linAlgMatrixLoadFromDescriptor.mC6M4N4U0S2(i32 325, %dx.types.Handle %6, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %9 = call %dx.types.LinAlgMatrixC9M8N8U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC9M8N8U0S1(i32 325, %dx.types.Handle %8, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %11 = call %dx.types.LinAlgMatrixC9M9N8U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC9M9N8U0S1(i32 325, %dx.types.Handle %10, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %13 = call %dx.types.LinAlgMatrixC9M8N9U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC9M8N9U0S1(i32 325, %dx.types.Handle %12, i32 0, i32 0, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %i8_matrix = call %dx.types.LinAlgMatrixC19M4N4U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC19M4N4U0S1(i32 325, %dx.types.Handle %2, i32 0, i32 4, i32 0, i32 4)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)

  ; okay
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M4N4U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M4N4U0S1 %5, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; okay only if offset accounts for byte width of component type
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M4N4U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M4N4U0S1 %5, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 32, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; okay only if stride accounts for byte width of component type
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M4N4U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M4N4U0S1 %5, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 4, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  ...
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M4N4U0S0.f32(i32 332, %dx.types.LinAlgMatrixC9M4N4U0S0 %3, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  ...
  call void @dx.op.linAlgMatrixStoreToMemory.mC6M4N4U0S2.f32(i32 332, %dx.types.LinAlgMatrixC6M4N4U0S2 %7, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; okay
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M8N8U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M8N8U0S1 %9, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  ...
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M9N8U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M9N8U0S1 %11, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; CHECK-NEXT: Function: main: error: Groupshared memory holds '64' scalars but must hold at least '72' scalars.
  ; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToMemory.mC9M8N9U0S1.f32
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M8N9U0S1.f32(i32 332, %dx.types.LinAlgMatrixC9M8N9U0S1 %13, float addrspace(3)* getelementptr inbounds ([64 x float], [64 x float] addrspace(3)* @"\01?SharedArr@@3PAMA", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; okay
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M8N8U0S1.v4f32(i32 332, %dx.types.LinAlgMatrixC9M8N8U0S1 %9, <4 x float> addrspace(3)* getelementptr inbounds ([16 x <4 x float>], [16 x <4 x float>] addrspace(3)* @"\01?SharedVecArr@@3PAV?$vector@M$03@@A", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; CHECK-NEXT: Function: main: error: Groupshared memory holds '64' scalars but must hold at least '72' scalars.
  ; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToMemory.mC9M9N8U0S1.v4f32
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M9N8U0S1.v4f32(i32 332, %dx.types.LinAlgMatrixC9M9N8U0S1 %11, <4 x float> addrspace(3)* getelementptr inbounds ([16 x <4 x float>], [16 x <4 x float>] addrspace(3)* @"\01?SharedVecArr@@3PAV?$vector@M$03@@A", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; CHECK-NEXT: Function: main: error: Groupshared memory holds '64' scalars but must hold at least '72' scalars.
  ; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToMemory.mC9M8N9U0S1.v4f32
  call void @dx.op.linAlgMatrixStoreToMemory.mC9M8N9U0S1.v4f32(i32 332, %dx.types.LinAlgMatrixC9M8N9U0S1 %13, <4 x float> addrspace(3)* getelementptr inbounds ([16 x <4 x float>], [16 x <4 x float>] addrspace(3)* @"\01?SharedVecArr@@3PAV?$vector@M$03@@A", i32 0, i32 0), i32 128, i32 16, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
  ...
  call void @dx.op.linAlgMatrixStoreToMemory.mC19M4N4U0S1.i32(i32 332, %dx.types.LinAlgMatrixC19M4N4U0S1 %i8_matrix, i32 addrspace(3)* getelementptr inbounds ([64 x i32], [64 x i32] addrspace(3)* @"\01?SharedIntArr@@3PAIA", i32 0, i32 0), i32 2, i32 4, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)

  ; CHECK-NEXT: Function: main: error: Parameter 'Stride' in bytes must be a multiple of 4, got 2 (2 elements * 1 bytes per element).
  ; CHECK-NEXT: note: at {{.*}} @dx.op.linAlgMatrixStoreToMemory.mC19M4N4U0S1.i32
  call void @dx.op.linAlgMatrixStoreToMemory.mC19M4N4U0S1.i32(i32 332, %dx.types.LinAlgMatrixC19M4N4U0S1 %i8_matrix, i32 addrspace(3)* getelementptr inbounds ([64 x i32], [64 x i32] addrspace(3)* @"\01?SharedIntArr@@3PAIA", i32 0, i32 0), i32 4, i32 2, i32 0)  ; LinAlgMatrixStoreToMemory(matrix,memory,offset,stride,layout)
