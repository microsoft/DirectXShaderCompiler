...
Pass *createDxilAnnotateFunctionPass();
void initializeDxilAnnotateFunctionPass(PassRegistry&);

Pass *createDxilFinalizeFunctionAnnotationsPass();
void initializeDxilFinalizeFunctionAnnotationsPass(PassRegistry&);
