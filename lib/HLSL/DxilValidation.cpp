...
_Use_decl_annotations_ HRESULT ValidateDxilModule(llvm::Module *pModule,
...
static void VerifyBlobPartMatches(_In_ ValidationContext &ValCtx,
                                  _In_ LPCSTR pName, DxilPartWriter *pWriter,
...
_Use_decl_annotations_ bool VerifySignatureMatches(llvm::Module *pModule,
                                                   DXIL::SignatureKind SigKind,
                                                   const void *pSigData,
                                                   uint32_t SigSize) {
...
_Use_decl_annotations_ bool VerifyPSVMatches(llvm::Module *pModule,
                                             const void *pPSVData,
                                             uint32_t PSVSize) {
  ValidationContext ValCtx(*pModule, nullptr, pModule->GetOrCreateDxilModule());
...
_Use_decl_annotations_ bool VerifyRDATMatches(llvm::Module *pModule,
...
VerifyFeatureInfoMatches(llvm::Module *pModule, const void *pFeatureInfoData,
...
_Use_decl_annotations_ HRESULT ValidateDxilContainerParts(
    llvm::Module *pModule, llvm::Module *pDebugModule,
    const DxilContainerHeader *pContainer, uint32_t ContainerSize) {
...
static HRESULT FindDxilPart(_In_reads_bytes_(ContainerSize)
                                const void *pContainerBytes,
                            _In_ uint32_t ContainerSize, _In_ DxilFourCC FourCC,
...
_Use_decl_annotations_ HRESULT ValidateLoadModule(
    const char *pIL, uint32_t ILLength, unique_ptr<llvm::Module> &pModule,
    LLVMContext &Ctx, llvm::raw_ostream &DiagStream, unsigned bLazyLoad) {
...
_Use_decl_annotations_ HRESULT ValidateDxilContainer(
    const void *pContainer, uint32_t ContainerSize,
    const void *pOptDebugBitcode, uint32_t OptDebugBitcodeSize,
...
ValidateDxilContainer(const void *pContainer, uint32_t ContainerSize,
                      llvm::raw_ostream &DiagStream) {
