...
public:
  ...
  STDMETHODIMP AccessField(_In_ LPCWSTR Name,
  ...
  STDMETHODIMP
  GetRegisterNumber(_Outptr_result_z_ DWORD *pRegisterNumber) override;
...
private:
  ...
  DxcPixDxilStructStorage(IMalloc *pMalloc, DxcPixDxilDebugInfo *pDxilDebugInfo,
                          IDxcPixType *OriginalType, IDxcPixStructType *pType,
