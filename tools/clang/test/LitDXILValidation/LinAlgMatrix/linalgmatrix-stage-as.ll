...
define void @mainAS() {
  ...
  %9 = call %dx.types.LinAlgMatrixC8M16N16U2S0 @dx.op.linAlgMatrixOuterProduct.mC8M16N16U2S0.v16f16.v16f16(i32 -2147483619, i1 true, <16 x half> %7, <16 x half> %7)  ; LinAlgMatrixOuterProduct(isInputSigned,vectorA,vectorB)
  ...
  call void @dx.op.linAlgMatrixAccumulateToDescriptor.mC8M16N16U2S0(i32 -2147483621, %dx.types.LinAlgMatrixC8M16N16U2S0 %9, %dx.types.Handle %10, i32 0, i32 0, i32 4, i32 128)  ; LinAlgMatrixAccumulateToDescriptor(matrix,handle,offset,stride,layout,align)
  ...
  call void @dx.op.linAlgVectorAccumulateToDescriptor.v16f16(i32 -2147483617, %dx.types.Handle %11, i32 0, i32 64, <16 x half> %7)  ; LinAlgVectorAccumulateToDescriptor(handle,offset,align,vector)
  ...
  %13 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U0S1(i32 -2147483634, %dx.types.Handle %12, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  ...
  %15 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixLoadFromDescriptor.mC8M16N16U2S1(i32 -2147483634, %dx.types.Handle %14, i32 0, i32 64, i32 0, i32 128)  ; LinAlgMatrixLoadFromDescriptor(handle,offset,stride,layout,align)
  %16 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixAccumulate.mC8M16N16U2S1.mC8M16N16U2S1.mC8M16N16U0S1(i32 -2147483624, %dx.types.LinAlgMatrixC8M16N16U2S1 %15, %dx.types.LinAlgMatrixC8M16N16U0S1 %13)  ; LinAlgMatrixAccumulate(matrixLHS,matrixRHS)
  %17 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U2S1(i32 -2147483632, %dx.types.LinAlgMatrixC8M16N16U2S1 %16)  ; LinAlgMatrixLength(matrix)
  %18 = call i32 @dx.op.linAlgMatrixQueryAccumulatorLayout(i32 -2147483626)  ; LinAlgMatrixQueryAccumulatorLayout()
  %19 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgFillMatrix.mC8M16N16U0S1.f32(i32 -2147483636, i1 true, float 0x40091EB860000000)  ; LinAlgFillMatrix(isInputSigned,value)
  %20 = call i32 @dx.op.linAlgMatrixLength.mC8M16N16U0S1(i32 -2147483632, %dx.types.LinAlgMatrixC8M16N16U0S1 %19)  ; LinAlgMatrixLength(matrix)
  %21 = call <2 x i32> @dx.op.linAlgMatrixGetCoordinate.mC8M16N16U0S1(i32 -2147483631, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20)  ; LinAlgMatrixGetCoordinate(matrix,threadLocalIndex)
  %22 = call half @dx.op.linAlgMatrixGetElement.f16.mC8M16N16U0S1(i32 -2147483630, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20)  ; LinAlgMatrixGetElement(matrix,threadLocalIndex)
  %23 = fadd fast half %22, 0xH3CEC
  %24 = call %dx.types.LinAlgMatrixC8M16N16U0S1 @dx.op.linAlgMatrixSetElement.mC8M16N16U0S1.mC8M16N16U0S1.f16(i32 -2147483629, %dx.types.LinAlgMatrixC8M16N16U0S1 %19, i32 %20, half %23)  ; LinAlgMatrixSetElement(matrix,threadLocalIndex,value)
  %25 = call %dx.types.LinAlgMatrixC8M16N16U1S1 @dx.op.linAlgMatrixLoadFromMemory.mC8M16N16U1S1.i32(i32 -2147483633, i32 addrspace(3)* getelementptr inbounds ([1024 x i32], [1024 x i32] addrspace(3)* @"\01?GSMemory@@3PA$ui8_4pk@A", i32 0, i32 0), i32 0, i32 64, i32 0)  ; LinAlgMatrixLoadFromMemory(memory,offset,stride,layout)
  %26 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiply.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1(i32 -2147483625, %dx.types.LinAlgMatrixC8M16N16U0S1 %24, %dx.types.LinAlgMatrixC8M16N16U1S1 %25)  ; LinAlgMatrixMultiply(matrixA,matrixB)
  %27 = call %dx.types.LinAlgMatrixC8M16N16U2S1 @dx.op.linAlgMatrixMultiplyAccumulate.mC8M16N16U2S1.mC8M16N16U0S1.mC8M16N16U1S1.mC8M16N16U2S1(i32 -2147483637, %dx.types.LinAlgMatrixC8M16N16U0S1 %24, %dx.types.LinAlgMatrixC8M16N16U1S1 %25, %dx.types.LinAlgMatrixC8M16N16U2S1 %26)  ; LinAlgMatrixMultiplyAccumulate(matrixA,matrixB,matrixC)
