...
min16float left93; min16int right93; left93 = right93;    /* expected-warning {{min16float is promoted to float16_t}} expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
...
min10float left105; min16int right105; left105 = right105; // expected-warning {{min10float is promoted to float16_t}} expected-warning {{min16int is promoted to int}} fxc-warning {{X3205: conversion from larger type to smaller, possible loss of data}} //
...
min16int left115; min16float right115; left115 = right115;    /* expected-warning {{min16float is promoted to float16_t}} expected-warning {{min16int is promoted to int}} fxc-pass {{}} */
min16int left116; min10float right116; left116 = right116;  // expected-warning {{min10float is promoted to float16_t}} expected-warning {{min16int is promoted to int}} fxc-pass {{}}
...
min16int left118; min12int right118; left118 = right118;  // expected-warning {{min12int is promoted to int16_t}} expected-warning {{min16int is promoted to int}} fxc-pass {{}}
min16int left119; min16uint right119; left119 = right119; /* expected-warning {{min16int is promoted to int}} expected-warning {{min16uint is promoted to uint16_t}} fxc-pass {{}} */
...
min12int left129; min16int right129; left129 = right129; // expected-warning {{min12int is promoted to int16_t}} expected-warning {{min16int is promoted to int}} fxc-warning {{X3205: conversion from larger type to smaller, possible loss of data}} //
...
min16uint left141; min16int right141; left141 = right141;    /* expected-warning {{min16int is promoted to int}} expected-warning {{min16uint is promoted to uint16_t}} fxc-pass {{}} */
