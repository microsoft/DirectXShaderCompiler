...
static void DecodeIITType(unsigned &NextElt, ArrayRef<unsigned char> Infos,
  ...
  case IIT_EMPTYSTRUCT:
    ...
    return;
  case IIT_STRUCT5: ++StructElts; __fallthrough; // HLSL Change
  case IIT_STRUCT4: ++StructElts; __fallthrough; // HLSL Change
  case IIT_STRUCT3: ++StructElts; __fallthrough; // HLSL Change
  case IIT_STRUCT2: {
